...
<body>
	<div id="right" style="padding: 15px 10px 0px 10px;">
		<div>
		    ...
		    <div id="borrowInfo">
		       <form id="form" action="personbgAddBorrow.do" method="post">
...
<%--								<s:select id="borrowType" name="paramMap.borrowType" list="#{1:'个人借款',2:'企业借款'}" cssClass="sel_140"></s:select>--%>
						...
						<tr height="8px;">
							...
							<td>
							 ...
							 <span class="fred"><s:fielderror fieldName="paramMap['borrowWay']"></s:fielderror></span>
							</td>
						</tr>
					<tr height="8px;">
						<td></td>
						...
						<tr>
						    ...
						    <td><input name="paramMap.title" type="text" class="inp280" maxlength="20" value="${paramMap.title}"/>
...
<%--						        <label><input type="radio" name="radio" id="r_2" value="2" />使用用户头像 </label>--%>
						  ...
						  <tr>
						    ...
						    <td >
						    <s:if test="#request.borrowWay==6">
						    	<s:select id="paymentMode" name="paramMap.paymentMode" list="borrowRepayWayList" cssClass="sel_140" listKey="id" listValue="name" headerKey="4" headerValue="一次性还款"></s:select>
						    </s:if><s:else>
						  ...
						  <tr>
						    ...
						    <td><textarea name="paramMap.detail" style="height: 100px; width: 320px; border: 1px solid #ddd;">${paramMap.detail}</textarea></td>
						  </tr>
						  <tr>
						     <td>&nbsp;</td>
						  ...
						  <span class="fred"><s:fielderror fieldName="paramMap['publishTime']"></s:fielderror></span>
						     ...
						     <!-- whb 添加是否专享标-->
			                <tr> 
			                   <td align="right">是否专享标：<span class="fred">*</span>   </td> 
			                   <td>
							    	<input type="hidden" id="isExclus" name="paramMap.isExclus" value="${paramMap.isExclus}"/>&nbsp;
							        <label><input type="radio" name="isExclusRadio" id="isExclus_0" value="0" checked="checked"/>否 </label>
							        <label><input type="radio" name="isExclusRadio" id="isExclus_1" value="1" />是</label>
							        </td>
			                </tr>
						  ...
						  <tr>
						    ...
						    <input id="bcbtn" value="发布借款" id="bcbtn" style="background: #666666;color: white;width: auto;margin-left: 100px;" type="button" />
						    </td>
						  </tr>
						   <tr height="8px;">
							<td></td>
