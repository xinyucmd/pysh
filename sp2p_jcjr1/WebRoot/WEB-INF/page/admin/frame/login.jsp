    ...
    <input type="hidden"  name="adminId" id="adminId"/>
         <div style="width: 100%; overflow: hidden;">
            <div style="float: left; width: 100%; text-align: left; padding:120px 0px 5px 0px;">
                <strong style=" width:518px; margin:0 auto; display:block;"><img src="../images/admin/sp2p.png" border="0"/><img src="../images/admin/logo.png" border="0" style="position:relative; left:10px; bottom:5px;"/></strong>
            </div>
          </div>
                        ...
                        <table width="518" border="0" align="center" cellpadding="0" cellspacing="0">
                            ...
                            <tr>
                                ...
                                <td valign="bottom">
                                    ...
                                    <img src="imageCode.do?pageId=adminlogin" title="点击更换验证码" style="cursor: pointer; vertical-align:-4px; *vertical-align:-1px; margin-left:10px;" id="codeNum" width="100px" height="24px" onclick="javascript:switchCode()"></img>
                            	</td>
                            </tr>
                            <tr height="20">
                            	<td></td>
