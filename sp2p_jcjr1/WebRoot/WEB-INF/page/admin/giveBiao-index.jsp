...
<body>
	...
	<div style="padding: 15px 10px 0px 10px;">
    	...
    	<div class="right_title">
    	 <form id="giveBiaoForm" action="giveBiao.do" method="post">
...
<%-- 	           <span>用户组：<s:select id="group" name="group" list="#{'1':'真实用户','2':'机构账户'}"   headerKey="-1" headerValue="--请选择--"></s:select></span> 
        ...
        <div style="width:1200px; margin-top:20px;">
        	<table class="zh_table" width="100%" cellspacing="0" cellpadding="0" border="0" style="margin-top:10px;">
                <tbody>
                    <tr>
                        <td>累计发标金额<br/>（元）</td>
                        <td style="color:#ff0000">${allGive }</td>
                        <td>新增发标金额<br/>（元）</td>
                        <td style="color:#ff0000">${feeMap.borrowAmount }</td>
                    </tr>
                </tbody>
           </table>	
        </div>
 ...
 */	praData["paramMap.borrowWay"] = $("#borrowWay").val();
	...
	$.shovePost("giveBiao.do",praData,initCallBack);
	}
