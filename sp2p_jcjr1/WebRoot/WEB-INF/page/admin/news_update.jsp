...
<html>
	...
	<s:hidden id="sort_" name="paramMap.sort"></s:hidden>
		<form id="updateTeam" name="updateTeam" action="updateNews.do" method="post">
						...
						<table border="0" cellspacing="0" cellpadding="0">
							<tr>
								...
								<td width="100"  class="main_alll_h2">
									<a href="updateNewsInit.do?id=${paramMap.id}">修改官方公告</a>
								</td>
								<td>
									&nbsp;
								</td>
							...
							<tr>
								...
								<td align="left" class="f66">
									...
									<s:textfield id="tb_sort" name="paramMap.sort"
										cssClass="in_text_150" theme="simple" value="%{#request.paramMap.sort}"></s:textfield>
							  ...
							  <td style="width: 100px; height: 25px;" align="right"
								...
								<td align="left" class="f66">
									<s:textfield id="tb_visist" name="paramMap.visits"
										cssClass="in_text_150" theme="simple" value="%{#request.paramMap.visits}"></s:textfield>
