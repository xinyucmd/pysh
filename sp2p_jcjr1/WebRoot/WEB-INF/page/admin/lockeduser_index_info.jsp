					...
					<tr class="gvItem">
						<td>
							<input id="gvNews_ctl02_cbID" class="adminId" type="checkbox"
								value="${bean.ids }" name="gvNews$ctl02$cbID" />
						</td>
					    ...
					    <td align="center">${idNo }</td>
					        <td align="center"><s:date name="#bean.lockTime" format="yyyy-MM-dd HH:mm:ss" /></td>
					   
			    	
							<td>
							
							<a id="gvNews_ctl02_lbDelete" style="cursor: pointer;"
										onclick="deleteById('${bean.ids }')">确认启用</a>
							<a  href="queryUserManageBaseInfoinner.do?i=${bean.ids }" target="main">查看</a>
