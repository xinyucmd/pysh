	...
	<head>
		...
		<script type="text/javascript">
			...
			function initListInfo(praData){							    
		 		$.shovePost("queryWxdCreateListPage.do",praData,initCallBack);
		 	}
			...
			/* function dels(){
		 	...
		 	function del(id){
	 			...
	 			window.location.href= "deleteLicai.do?id="+id;
		 	}
						...
						<tr>
							...
							<td width="2">
							 ...
							 <td width="100" height="28"  class="main_alll_h2">
								<a href="queryWxdCreateListInit.do">微信贷原创管理</a>
							</td>
							<td width="2">
								&nbsp;
							</td>
							<td width="100"  class="xxk_all_a">
								<a href="addWxdCreateInit.do">添加微信贷原创</a>
							</td>
							<td width="2">
								&nbsp;
							</td>
