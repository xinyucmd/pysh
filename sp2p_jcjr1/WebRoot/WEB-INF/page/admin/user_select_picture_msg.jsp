     ...
     <div align="center">
        <table width="100%">
         ...
         <s:iterator value="pageBean.page" var="bean" status="sta">
          ...
          <a href="queryPersonPictureDateindex.do?userId=${ids }&TypeId=${materAuthTypeId}&adf=${tmdid }">审核</a>
          </s:if>
          <s:else><a href="queryPersonPictureDateindex.do?userId=${ids }&TypeId=${materAuthTypeId}&adf=${tmdid }">查看</a></s:else>
          </td>
             </tr>
          </s:iterator>
          </s:else>
