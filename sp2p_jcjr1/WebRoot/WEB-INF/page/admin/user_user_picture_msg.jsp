...
<script>
 ...
 var flag = true;
  ...
  param["paramMap.criditing"] = '${criditing}';
        ...
        <table style="width: 100%; color: #333333;"
         ...
         <s:iterator value="pageBean.page" var="bean" status="sta">
          ...
          <td >${checkperson }</td><td>
            ...
            <s:date name="passTime" format="yyyy-MM-dd HH:mm:ss" />
          </td><td>
          <s:if test="#bean.auditStatus==1">
          <a href="querybasepicture.do?userId=${ids }&TypeId=${materAuthTypeId}&adf=${tmdid }">审核</a>
          </s:if>
          <s:else><a href="querybasepicture.do?userId=${ids }&TypeId=${materAuthTypeId}&adf=${tmdid }">查看</a></s:else>
          </td>
             </tr>
          </s:iterator>
          </s:else>
