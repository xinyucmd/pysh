					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
						<tr>
						  <td width="100" height="28"  class="main_alll_h2">
								<a href="javascript:void(0);">推荐明细</a>
							</td>
							<td width="2">
								&nbsp;
							</td>
						...
						<tbody>
							<tr>
								<td class="f66" align="left" width="50%" height="36px">
									...
									好友来源:
									<s:select id="type" name = "paramMap.type" list="#{-1:'--请选择--',1:'邀请链接',2:'二维码扫码',3:'填写推荐人'}"></s:select>&nbsp;&nbsp;
...
<script type="text/javascript">
			...
			function initListInfo(praData){
				...
				praData["paramMap.userId"] = $("#userId").val();
		 		$.shovePost("queryRecommendDetailList.do",praData,initCallBack);
		 	}
