...
<div style="padding: 15px 10px 0px 10px;">
		<table id="gvNews" style="width: 100%; color: #333333;"
			...
			<tbody>
				...
				<td colspan="4" align="right" >当前页的等待资料借款金额合计:</td>
				<td  align="center" >￥${waitingAuditAmount}</td>	
				<td colspan="3" align="right" >等待资料借款总金额合计:</td>
				<td  colspan="2" >￥<s:if test="%{#request.waitTotalAmount.totalWaitBorrowAmount==''}">0.00</s:if><s:else>
		                <s:property value="#request.waitTotalAmount.totalWaitBorrowAmount" default="0"/></s:else>
		                </td>		
				</tr>
			</tbody>
		</table>
