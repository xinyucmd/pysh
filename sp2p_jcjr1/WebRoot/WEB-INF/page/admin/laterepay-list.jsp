...
<div style="padding: 15px 10px 0px 10px;">
		<table id="gvNews" style="width: 100%; color: #333333;" cellspacing="1" cellpadding="3" bgcolor="#dee7ef" border="0">
			<tbody>
				...
				<td colspan="2">￥<s:if test="#request.lateRepayMap.totalSumm==''">0.00</s:if><s:else>${lateRepayMap.totalSumm}</s:else></td>
				...
				<td colspan="2">￥<s:if test="#request.lateRepayMap.totallateFI==''">0.00</s:if><s:else>${lateRepayMap.totallateFI}</s:else></td>
				...
				<td colspan="2">￥<s:if test="#request.lateRepayMap.amount==''">0.00</s:if><s:else>${lateRepayMap.amount}</s:else></td>
