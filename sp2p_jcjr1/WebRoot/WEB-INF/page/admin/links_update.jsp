...
<html>
	...
	<body>
		<form id="updateLinks" name="updateLinks" action="updateLinks.do" method="post">
						...
						<table border="0" cellspacing="0" cellpadding="0">
							<tr>
								...
								<td width="100" class="main_alll_h2">
									<a href="javascript:void(0);">修改友情链接</a>
								</td>
								<td>
									&nbsp;                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        
								</td>
					...
					<div style="width: auto; background-color: #FFF; padding: 10px;">
						<table width="100%" border="0" cellspacing="1" cellpadding="3">
							...
							<tr>
								...
								<td align="left" class="f66">
									<s:hidden id="tb_id" name="paramMap.serialCount" 
										cssClass="in_text_2" cssStyle="width: 150px" theme="simple" readonly="true" ></s:hidden>
