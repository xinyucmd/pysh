					...
					<table style="margin-bottom: 8px;" cellspacing="0" cellpadding="0"
						...
						<tbody>
							...
							<tr>
								<td class="f66" align="left" width="50%" height="36px">
									借款类型：
									<s:select id="borrowWay" list="#{-1:'--请选择--',1:'净值借款',2:'秒还借款',3:'信用借款',4:'定息宝',5:'机构担保借款',6:'活利宝'}"></s:select>
									&nbsp;&nbsp;
									用户组：
...
<script type="text/javascript">
			$(function(){
				...
				$("#excel").attr("disabled",true);
				       window.location.href=encodeURI(encodeURI("exportforPayment.do?inverse="+$("#inverse").attr("checked")+"&&borrowWayid="+$("#borrowWay").val()+"&&groupId="+$("#group").val()+"&&investor="+$("#investor").val()+"&&timeStart="+$("#timeStart").val()+"&&timeEnd="+$("#timeEnd").val()+"&&titles="+$("#titles").val()));
			...
			function initListInfo(praData){
				...
				//-----------
		 		$.shovePost("forPaymentList.do",praData,initCallBack);
		 	}
		 	function test(){
