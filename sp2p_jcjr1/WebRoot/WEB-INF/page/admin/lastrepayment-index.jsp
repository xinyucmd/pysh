						...
						<tbody>
						    <tr>
								<td class="f66" align="left" width="50%" height="36px">
									...
									借款类型：
									<s:select id="borrowWay" list="#{-1:'--请选择--',3:'优选',4:'定息宝',6:'活利宝'}" ></s:select>
								</td>
							</tr>
							<tr>
								<td class="f66" align="left" width="50%" height="36px">
...
<script type="text/javascript">
				...
				param["pageBean.pageNum"] = 1;
			     ...
			     $("#excel").click(function(){
			        ...
			        /*   if($("#today").hasClass("main_alll_h2")){
			          ...
			          window.location.href=encodeURI(encodeURI("exportlastRepayMent.do?type=2"+"&&userName="+$("#userName").val()+"&&realName="+$("#realName").val()+"&&borrowWay="+$("#borrowWay").val()+"&&timeStart="+$("#timeStart").val()+"&&timeEnd="+$("#timeEnd").val()+"&&titles="+$("#titles").val()));
		              setTimeout("test()",3000);
		              return;
			         // }
	...
	/* 		whb修改最近三天为1个月
           ...
           //whb添加充值
            function addRechargeInit(id){
			  window.location.href= "addRechargeInit.do?paramMap.id="+id;
			}
</script>
</html>
