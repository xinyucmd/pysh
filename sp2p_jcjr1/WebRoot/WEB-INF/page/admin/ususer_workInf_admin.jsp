   ...
   if($("#moredRelation").val() ==""){
     ...
     return ;
		...
		$("#jc_yes").click(function(){
			...
			var occStatus = $('#occStatus').val();
			var workPro	= $('#workPro').val();
			var	workCity = $('#workCity').val();
			var	companyType	= $('#companyType').val();	
			var	companyLine	= $('#companyLine').val();
			...
			if('' == orgName||'' == occStatus||'' == workPro||'' == workCity||'' == companyType||'' == companyLine||'' == companyScale||'' == job
			||'' == monthlyIncome||'' == workYear||'' == companyTel||'' == workEmail||'' == companyAddress){
				alert('工作信息未完善,暂时无法审核!');
				return false;
			}
