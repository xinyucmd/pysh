						...
						<table width="100%" border="0" cellspacing="1" cellpadding="3">
							<tr>
								...
								<td align="left" class="f66">
									<s:select list="roleList.{?#this.id!=1&&#this.id!=2}" name="paramMap.roleId" listKey="id" listValue="name" headerKey="-2" headerValue="--请选择--"></s:select>
							...
							<tr>
								...
								<td align="left" class="f66">
								    <s:hidden name="paramMap.img" id="updateAdmin_paramMap_img"/>
									<img id="img" src="../${paramMap.img }" width="62" height="62"/> <a href="javascript:void(0);" id="btn_personalHead" class="scbtn">上传图片</a>
								    <span style="color: red;">*<s:fielderror
