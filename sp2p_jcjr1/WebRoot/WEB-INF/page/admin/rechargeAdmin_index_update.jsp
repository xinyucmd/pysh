						...
						<tr>
							...
							<td width="2">
								...
								<td width="100" align="center" class="main_alll_h2">
									<a href="javascript:void(0);">线下充值审核</a>
								</td>
							<td>
								&nbsp;
							</td>
    ...
    <form id="addAdmin" action="updateRechargeDetailStatusById.do" method="post">
		<table id="gvNews" style="width: 100%; color: #333333;"
			...
			<tbody>
				...
				<s:hidden name="paramMap.ids" />
				<s:hidden name="paramMap.type" value="" id="ty"/>
				<s:hidden name="paramMap.userIds"/>
				...
				<tr class="gvItem">
					...
					<tr class="gvItem">
						...
						<td align="center" colspan="3">
					      <input type="text" id="checkremark" name="paramMap.checkremark" value="${paramMap.checkremark }">
					   </td>
					</tr>
