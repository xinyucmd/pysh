		...
		<script type="text/javascript">
			$(function(){
				...
				$("#excelout").click(function(){ 
                       ...
                       window.location.href=encodeURI(encodeURI("exportBackCash.do?checkUser="+$("#checkUser").val()+"&&startTime="+$("#startTime").val()+"&&endTime="+$("#endTime").val()+"&&userIdName="+$("#userId").val()+"&&type="+$("#type").val()));
			...
			function addRecharge(){
			  ...
			  window.location.href= "addBackRechargeInit.do?paramMap.userId="+userId;
			}
			
			function addWithdraw(){
			   var userId = $('#userId').val();
			  window.location.href= "addBackWithdrawInit.do?paramMap.userId="+userId;
			}
