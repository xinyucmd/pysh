		...
		var flag = true;
		  $(function(){
		      //提交表单
				...
				if($("#tb_title").val() == "秒还借款"){
					param["tb_period_month"] = "1,3,7";
					param["tb_period_day"] ="1,2,9";
					}
				else{
				...
				<div style="padding: 15px 10px 0px 10px;">
					...
					<div style="width: auto; background-color: #FFF; padding: 20px;">
						<table width="800" border="0" cellspacing="1" cellpadding="3"  align="center" >
							...
							<s:if test="%{'seconds' eq paramMap.nid}">
							</s:if>
							<s:else>
							<tr>
								<td style="width: 100px; height: 30px;" align="right"
							...
							<tr>
								<td style="width: 120px; height: 30px;" align="right" class="blue12">
									最高投标金额：
								</td>
								<td align="left" class="f66">
