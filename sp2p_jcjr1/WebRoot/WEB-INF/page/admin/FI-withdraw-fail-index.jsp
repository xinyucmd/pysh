		...
		<script type="text/javascript">
			$(function(){
				...
				$("#excel").click(function(){
                         ...
                         window.location.href= encodeURI(encodeURI("exportAllWithdraw.do?userName="+$("#userName").val()+"&&startTime="+$("#startTime").val()+"&&endTime="+$("#endTime").val()+"&&statss=5"));
