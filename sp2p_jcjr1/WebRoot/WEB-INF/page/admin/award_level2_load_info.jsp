	...
	<div>
		<table id="gvNews" style="width: 100%; color: #333333;"
			...
			<tbody>
				...
				&nbsp;&nbsp;奖励总合计:
				￥<s:if test="%{paramMap.sumLeve2Money==''}">0.00</s:if><s:else>
					<s:property value="paramMap.sumLeve2Money" default="0"/></s:else></td>
				<td colspan="1" align="right" >当前页的经纪人奖励合计:</td>
				<td  align="center" ><fmt:formatNumber value="${sumLeve2M}" type="currency" pattern="￥0.00"/></td>			
				</tr>
			</tbody>
		</table>
	</div>
