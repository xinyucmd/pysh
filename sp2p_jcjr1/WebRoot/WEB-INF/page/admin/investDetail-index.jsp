						...
						<tbody>
							...
							<tr>
								<td class="f66" align="left" width="50%" height="36px">
									...
									<input id="investor" type="hidden" value="${investor}"/>
								</td>
							</tr>
						</tbody>
					</table>
...
<script type="text/javascript">
			$(function(){
				...
				$("#excel").click(function(){
				  ...
				  window.location.href=encodeURI(encodeURI("exportinvestDetail.do?bTitle="+$("#bTitle").val()+"&&deadline="+$("#deadline").val()+"&&timeStart="+$("#timeStart").val()+"&&timeEnd="+$("#timeEnd").val()+"&&borrowWay="+$("#borrowWay").val()+"&&isAutoBid="+$("#isAutoBid").val()+"&&amountDown="+$("#amountDown").val()+"&&amountUp="+$("#amountUp").val()));
