...
<body style=" background:url(../images/admin/login_bg.png) top;">
    <form id="form" action="setpass.do" method="post">
                ...
                <div style="margin-left: auto; margin-right: auto;">
                    <div style="background-image: url(../images/admin/login_kuang_bg.png); overflow:hidden; height:259px;">
                        <table width="518" border="0" align="center" cellpadding="0" cellspacing="0">
                        	<tr height="40">
                        		<td></td>
                                <td style="color: red; font-size:18px;">超级管理员初次登录，请设置密码</td>
                            </tr>
                            <tr>
                                <td  width="100" align="right" style="color:#fff; font-size:14px; font-weight:bold;">登录密码：</td>
                                <td width="300">
                                	<s:password id="password" name="paramMap.password" theme="simple" maxlength="25" cssClass="login_text" cssStyle="width: 280px"></s:password>
                                </td>
                            </tr>
                            <tr height="20">
                            	<td></td>
                            ...
                            <tr>
                                <td  width="100" align="right" style="color:#fff; font-size:14px; font-weight:bold;">确认密码：</td>
                                <td>
                                	<s:password name="paramMap.confirmPass" cssClass="login_text" cssStyle="width: 280px" theme="simple" maxlength="20"></s:password>
                                </td>
                            </tr>
                            <tr height="20">
                            	<td></td>
                                <td><span style="color: red; font-size:12px;"><s:fielderror fieldName="paramMap.confirmPass" /></span></td>
                            </tr>
                            <tr>
                                <td width="100" align="right" style="color:#fff; font-size:14px; font-weight:bold;">验证码：</td>
                                <td valign="bottom">
                                	<s:textfield  name="paramMap.code" cssClass="login_text" theme="simple" cssStyle="width: 120px" value=""/>
