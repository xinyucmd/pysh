...
<html>
	...
	<body>
			...
			<tbody>
						    ...
						    <td>
						    <s:if test="#request.SelectCledit.tmhouseauditStatus==3"><a href="queryselectindex.do?userId=${map.ids}&TypeId=6">查看</a></s:if>
						    <s:elseif test="#request.SelectCledit.tmhouseauditStatus==2"><a href="queryselectindex.do?userId=${map.ids}&TypeId=6">查看</a></s:elseif>
						    <s:elseif test="#request.SelectCledit.tmhouseauditStatus==1"><a href="queryselectindex.do?userId=${map.ids}&TypeId=6">审核</a></s:elseif>
						    <s:else>--</s:else>
						    </td>
							<!-- -->
							</tr>
						    ...
						    <td><s:if test="#request.SelectCledit.tmcarauditStatus==3"><a href="queryselectindex.do?userId=${map.ids}&TypeId=7">查看</a></s:if>
						    <s:elseif test="#request.SelectCledit.tmcarauditStatus==2"><a href="queryselectindex.do?userId=${map.ids}&TypeId=7">查看</a></s:elseif>
						    <s:elseif test="#request.SelectCledit.tmcarauditStatus==1"><a href="queryselectindex.do?userId=${map.ids}&TypeId=7">审核</a></s:elseif>
						    <s:else>--</s:else></td>
							<!--  -->
							</tr>
							<tr class="gvItem">
						 ...
						 ${SelectCledit.merraycriditing }
						    ...
						    <s:if test="#request.SelectCledit.tmmerrayauditStatus==3"><a href="queryselectindex.do?userId=${map.ids}&TypeId=8">查看</a></s:if>
						    <s:elseif test="#request.SelectCledit.tmmerrayauditStatus==2"><a href="queryselectindex.do?userId=${map.ids}&TypeId=8">查看</a></s:elseif>
						    <s:elseif test="#request.SelectCledit.tmmerrayauditStatus==1"><a href="queryselectindex.do?userId=${map.ids}&TypeId=8">审核</a></s:elseif>
						    <s:else>--</s:else>
						    </td>
							<!--  -->
							</tr>
						<tr class="gvItem">
						  ...
						  ${SelectCledit.xuelicriditing }
						    ...
						    <td>${SelectCledit.xuelioption}</td><td>${SelectCledit.xueliauthTime }</td><td>
						     <s:if test="#request.SelectCledit.tmxueliauditStatus==3"><a href="queryselectindex.do?userId=${map.ids}&TypeId=9">查看</s:if>
						    <s:elseif test="#request.SelectCledit.tmxueliauditStatus==2"><a href="queryselectindex.do?userId=${map.ids}&TypeId=9">查看</a></s:elseif>
						    <s:elseif test="#request.SelectCledit.tmxueliauditStatus==1"><a href="queryselectindex.do?userId=${map.ids}&TypeId=9">审核</a></s:elseif>
						    <s:else>--</s:else>
						    </td>
							<!--  -->
							</tr>
						  ...
						  ${SelectCledit.jishucriditing }
						    ...
						    <td>${SelectCledit.jishuoption}</td><td>${SelectCledit.jishuauthTime }</td><td>
						       <s:if test="#request.SelectCledit.tmjishuauditStatus==3"><a href="queryselectindex.do?userId=${map.ids}&TypeId=10">查看</a></s:if>
						    <s:elseif test="#request.SelectCledit.tmjishuauditStatus==2"><a href="queryselectindex.do?userId=${map.ids}&TypeId=10">查看</a></s:elseif>
						    <s:elseif test="#request.SelectCledit.tmjishuauditStatus==1"><a href="queryselectindex.do?userId=${map.ids}&TypeId=10">审核</a></s:elseif>
						    <s:else>--</s:else>
						    </td>
						    <!--  -->
						    </tr>
					 ...
					 ${SelectCledit.telephonecriditing }
						    ...
						    <td>${SelectCledit.telephoneoption}</td><td>${SelectCledit.telephoneauthTime }</td><td>
						         <s:if test="#request.SelectCledit.tmtelephoneauditStatus==3"><a href="queryselectindex.do?userId=${map.ids}&TypeId=11">查看</a></s:if>
						    <s:elseif test="#request.SelectCledit.tmtelephoneauditStatus==2"><a href="queryselectindex.do?userId=${map.ids}&TypeId=11">查看</a></s:elseif>
						    <s:elseif test="#request.SelectCledit.tmtelephoneauditStatus==1"><a href="queryselectindex.do?userId=${map.ids}&TypeId=11">审核</a></s:elseif>
						    <s:else>--</s:else>
						    </td>
							<!--  -->
							</tr>
						    ...
						    <td>${SelectCledit.weibooption}</td><td>${SelectCledit.weiboauthTime }</td><td>
						         <s:if test="#request.SelectCledit.tmweiboauditStatus==3"><a href="queryselectindex.do?userId=${map.ids}&TypeId=12">查看</a></s:if>
						    <s:elseif test="#request.SelectCledit.tmweiboauditStatus==2"><a href="queryselectindex.do?userId=${map.ids}&TypeId=12">查看</a></s:elseif>
						    <s:elseif test="#request.SelectCledit.tmweiboauditStatus==1"><a href="queryselectindex.do?userId=${map.ids}&TypeId=12">审核</a></s:elseif>
						    <s:else>--</s:else>
						    </td>
							<!--  -->
							</tr>
							...
							<tr class="gvItem">
							<!--  -->
							<td>抵押</td><td><s:if test="#request.SelectCledit.tmxcauditStatus==1">待审核</s:if>
						    ...
						    <td>${SelectCledit.xcoption}</td><td>${SelectCledit.xcauthTime }</td><td>
						             ...
						             <s:if test="#request.SelectCledit.tmxcauditStatus==3"><a href="queryselectindex.do?userId=${map.ids}&TypeId=13">查看</a></s:if>
						    <s:elseif test="#request.SelectCledit.tmxcauditStatus==2"><a href="queryselectindex.do?userId=${map.ids}&TypeId=13">查看</a></s:elseif>
						    <s:elseif test="#request.SelectCledit.tmxcauditStatus==1"><a href="queryselectindex.do?userId=${map.ids}&TypeId=13">审核</a></s:elseif>
						    <s:else>--</s:else>
						    </td>
							<!--  -->
							</tr>
							<tr class="gvItem">
							<!--  -->
							<td>现场</td><td><s:if test="#request.SelectCledit.tmdiyaauditStatus==1">待审核</s:if>
						    ...
						    <td>${SelectCledit.diyaoption}</td><td>${SelectCledit.diyaauthTime }</td><td>
						             ...
						             <s:if test="#request.SelectCledit.tmdiyaauditStatus==3"><a href="queryselectindex.do?userId=${map.ids}&TypeId=14">查看</a></s:if>
						    <s:elseif test="#request.SelectCledit.tmdiyaauditStatus==2"><a href="queryselectindex.do?userId=${map.ids}&TypeId=14">查看</a></s:elseif>
						    <s:elseif test="#request.SelectCledit.tmdiyaauditStatus==1"><a href="queryselectindex.do?userId=${map.ids}&TypeId=14">审核</a></s:elseif>
						    <s:else>--</s:else>
						    </td>
						    <!--  -->
						    </tr>
						 ...
						 <!--  modify by houli 放错地方了    ${SelectCledit.danbaooption} -->
						    <td>${SelectCledit.danbaooption}</td><td>${SelectCledit.danbaoauthTime }</td><td>
						             <s:if test="#request.SelectCledit.tmdanbaoauditStatus==3"><a href="queryselectindex.do?userId=${map.ids}&TypeId=15">查看</a></s:if>
						    <s:elseif test="#request.SelectCledit.tmdanbaoauditStatus==2"><a href="queryselectindex.do?userId=${map.ids}&TypeId=15">查看</a></s:elseif>
						    <s:elseif test="#request.SelectCledit.tmdanbaoauditStatus==1"><a href="queryselectindex.do?userId=${map.ids}&TypeId=15">审核</a></s:elseif>
						    <s:else>--</s:else>
						    ...
						    <td>${SelectCledit.qitaoption}</td><td>${SelectCledit.qitaauthTime }</td><td>
						             ...
						             <s:if test="#request.SelectCledit.tmqitaauditStatus==3"><a href="queryselectindex.do?userId=${map.ids}&TypeId=16">查看</a></s:if>
						    <s:elseif test="#request.SelectCledit.tmqitaauditStatus==2"><a href="queryselectindex.do?userId=${map.ids}&TypeId=16">查看</a></s:elseif>
						    <s:elseif test="#request.SelectCledit.tmqitaauditStatus==1"><a href="queryselectindex.do?userId=${map.ids}&TypeId=16">审核</a></s:elseif>
						    <s:else>--</s:else>
						    </td>
						    <!--  -->
						    </tr>
