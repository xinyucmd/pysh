...
<div style="padding: 15px 10px 0px 10px;">
		<table id="gvNews" style="width: 100%; color: #333333;"
			...
			<tbody>
				...
				<td colspan="4" align="right" >当前页的满标借款金额合计:</td>
				<td  align="center" >￥${fistAuditAmount}</td>	
				<td colspan="3" align="right" >满标借款总金额合计:</td>
				<td  colspan="2" >￥<s:if test="%{#request.repaymentMap.fullScaleTotalAmount==''}">0.00</s:if><s:else>
		                <s:property value="#request.repaymentMap.fullScaleTotalAmount" default="0"/></s:else></td>		
				</tr>
			</tbody>
		</table>
</div>
