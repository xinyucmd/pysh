	...
	<head>
	   ...
	   function initListInfo(praData) {
			...
			param["endDate"] = $("#endDate").val();
	   		$.shovePost("querybankeditInfo.do",praData,initCallBack);
   		}
   		...
   		//删除单个
   		function deleteRechargeById(ids){
	 		if(window.confirm("确定要删除吗?")){
	 			window.location.href = "delRechargeBankInit.do?id="+ids
	 		}
   		}
					...
					<table width="240px" border="0" cellspacing="0" cellpadding="0">
						<tr>
							...
							<td width="2">
								...
								<a href="addRechargeBankInit.do">添加充值银行卡</a>
							</td>
								<td width="2">
								&nbsp;
							</td>
