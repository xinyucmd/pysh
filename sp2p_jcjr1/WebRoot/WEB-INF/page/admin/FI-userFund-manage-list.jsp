				...
				<s:set name="counts" value="#request.pageNum"/>
					<s:iterator value="pageBean.page" var="bean" status="s">
						<tr class="gvItem">
							...
							<td>
							<a href="queryUserFundRechargeInit.do?userId=${bean.ids }" target="main" >充值记录</a>&nbsp;&nbsp;
							  <a href="queryUserFundWithdrawInit.do?userId=${bean.ids }" target="main" >提现管理</a>&nbsp;&nbsp;
							  <a href="queryUserFundrecordInit.do?userId=${bean.ids }&userName=${bean.username }" 
							  target="main" >资金记录</a>
							</td>
						</tr>
					</s:iterator>
					<tr>
						...
						<td colspan="2">待收总额：${map.dueinSumss }</td>
