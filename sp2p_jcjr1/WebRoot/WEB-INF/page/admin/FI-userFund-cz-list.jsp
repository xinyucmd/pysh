				...
				<s:set name="counts" value="#request.pageNum"/>
					<s:iterator value="pageBean.page" var="bean" status="s">
						<tr class="gvItem">
							...
							<s:if test="#bean.type==4">线下充值</s:if>
							<s:if test="#bean.type==5">手工充值</s:if>
							<s:if test="#bean.type==6">虚拟充值</s:if>
							<s:if test="#bean.type==7">奖励充值</s:if>
							<s:if test="#bean.type==10">连连支付-手机</s:if>
							</td>
							<td>
								${bean.rechargeMoney}
							</td>
