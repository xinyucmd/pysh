											...
											<tr>
												...
												<td>
													<input type="text" class="inp188" name="paramMap.cellPhone"
														id="cellPhone" value="${map.cellPhone }" readonly="readonly" />
											...
											<tr>
												...
												<s:else></s:else>
													...
													<input type="radio" name="paramMap_maritalStatus"
														...
														<s:else></s:else> <s:if test='#request.flag == "1"'>disabled="disabled"</s:if>
														onclick="javascript:$('#u_maritalStatus').html('')"
														/>
													离异
													<input type="radio" name="paramMap_maritalStatus"
 ...
 //============
   ...
   <script>
     ...
     $("#jc_yes").click(function(){
		if($("#realName").val() ==""){
			alert("请输入姓名，修改资料后请点击修改并保存");
			return;
		}
		if($("#idNo").val() ==""){
			alert("请输入身份证号，修改资料后请点击修改并保存");
			return;
		}
		if($("#cellPhone").val() ==""){
			alert("请输入手机号，修改资料后请点击修改并保存");
			return;
		}
	   var param = {};
