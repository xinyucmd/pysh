				...
				<div style="padding: 15px 10px 0px 10px;">
					...
					<div class="tab">
						<table cellspacing="1" cellpadding="3">
							...
							<tr>
								<td colspan="2" class="blue12 left">
									借款人认证审核查看：<a href="queryPerUserCreditAction.do?userId=${borrowMTenderInDetail.new_userId}&userId_admin=${borrowMTenderInDetail.new_userId_admin}&publisWay=${borrowMTenderInDetail.publisherWay}" target="_blank">申请人认证详情查看</a>
								</td>
							</tr>
                            <tr>
								<td colspan="2" class="blue12 left">
