...
<html>
		...
		<script>
			...
			$(function(){
				...
				$("#bt_down").click(function(){
					...
					var dir = getDirNum();
					var json = "{'fileType':'"+fileType+"','fileSource':'download/"+dir+"','fileLimitSize':10,'title':'上传文件','cfn':'uploadCall','cp':'doc'}";
	...
	<body>
		<form id="updateDownload" name="updateDownload" action="updateDownload.do" method="post">
						...
						<table border="0" cellspacing="0" cellpadding="0">
							<tr>
								...
								<td width="100"  class="main_alll_h2">
									<a href="updateDownloadInit.do?id=${paramMap.id}">修改资料</a>
								</td>
								<td>
									&nbsp;
								</td>
