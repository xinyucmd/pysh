			...
			<tbody>
				...
				<s:iterator value="pageBean.page" var="bean" status="s">
					<tr class="gvItem">
						...
						<td>
						 工作信息状态 
						    <s:if test="#bean.workauditStatus==1">基本信息完整<a style="color: gray;">(待审核)</a></s:if>
						 ...
						 联系信息审核 
							   ...
							   <s:if test="#bean.workauditStatus!=null">
							       <s:if test="#bean.directedStatus==1">
							        基本信息完整<a style="color: gray;">(待审核)</a>
							       </s:if>
							       <s:elseif test="#bean.directedStatus==2">
							         基本信息完整<a style="color: red;">(失败)</a>
							       </s:elseif>
							       <s:elseif test="#bean.directedStatus==3">
							            ...
							            <s:elseif test="#bean.otherStatus==3">
							                ...
							                <s:elseif test="#bean.moredStatus==3">
							                   基本信息完整<a style="color: blue;">(成功)</a>
							                </s:elseif>
						...
						<td>
						<a href="adminBase.do?uid=${ids}">查看</a>
					</td>
					</tr>
				</s:iterator>
				</s:else>
