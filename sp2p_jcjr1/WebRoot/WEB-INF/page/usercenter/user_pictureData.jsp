...
<div class="s_jkmain clearfix">
      ...
      <div class="l_nav clearfix">
		<ul class="clearfix"><li ><a href="querBaseData.do?from=${from }"><span>step1 </span> 基本资料</a></li>
		    <li class="on">
      ...
      <div class="r_main clearfix">
         ...
         <div class="jkdet_content clearfix">
             <p class="tips">	
               温馨提示：微信贷对于用户上传的所有信息，都将进行加密处理。您可以在此放心上传个人材料，您的个人信用将不会被以任何形式外泄。<br /> 
			   <em class="fred">注：认证资料上传完毕后，等待后台进行审核。</em>
             </p>
             <!--必要信用认证-->
             <div class="zlsc_box clearfix">
             	 <h4>必要信用认证</h4>
                 <p>为了保证审核效率，确保贷款用户尽快通过审核，我们将优先为五项必要认证材料上传齐全的用户提供审核服务。五项必要认证 缺失的用户，无法得到贷款。</p>
                 ...
                 <p>您可以选择上传的认证项目，只要通过了这些可选信用认证，将会提高您的"信用等级"和"信用额度" 。</p>
             	 <ul class="kxrz_ul clearfix">
					...
					<s:iterator value="#request.selectpictur" var="bean" status="sta">
			   		...
			   		<li>
                    	<div class="sc_pic"><img src="" width="62" height="62" id="img_fc" style="display: none;"/></div>
                        <div class="sc_txt">
                        	<h6>${tmyname }</h6>
                            <input type="button"  class="scbtn" style="cursor: pointer;" sd="${tmid }" value="点击上传" onclick="fff(this)"/>
                        </div>
