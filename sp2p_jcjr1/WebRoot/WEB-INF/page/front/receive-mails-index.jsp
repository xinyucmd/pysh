...
<script type="text/javascript">
    ...
    function showSysMailInfo(id,type){
     ...
     function delReceives(){
		...
		$.shovePost("deleteReceiveMails.do",{ids:ids},function(data){
           $("#receive_mail_list").html(data);
        });
	}
	...
	function readedReceives(){
		...
		$.shovePost("updateReceive2Readed.do",param,function(data){
           $("#receive_mail_list").html(data);
        });
	}
...
<div class="boxmain2">
      <div class="srh" id="re_srh">
       <input class="myhome_btn" onclick="delReceives();" value="删除" type="button"/>
        <input class="myhome_btn" onclick="readedReceives();" value="标记为已读" type="button" />
        <input class="myhome_btn" onclick="unReadReceives();" value="标记为未读" type="button" />
        <input class="myhome_btn" onclick="showUnReadReceives();" value="未读邮件" type="button"/>
    </div>
