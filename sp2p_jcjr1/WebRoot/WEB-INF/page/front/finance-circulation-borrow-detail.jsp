...
份&nbsp;&nbsp; </div></td>
 -->
  ...
  <tr>
    <td>信用指数： <img src="images/ico_${borrowUserMap.credit}.jpg" title="${borrowUserMap.creditrating}分" width="33" height="22" /></td>
  </tr>
  <tr>
  ...
  <div class="ifbox2">
    ...
    <div class="tips">
    以下基本信息资料，经用户同意披露。其中<span class="fred">红色</span>字体的信息，为通过${sitemap.siteName}审核之项目。<br/>
    </div>
    <div class="infotab">
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
  ...
  <s:if test="%{#request.list !=null && #request.list.size()>0}">
      ...
      <tr>
          ...
          <s:if test="#bean.auditStatus == 3">
              <a href="javascript:showImg('${bean.materAuthTypeId}','${enUserId}');">查看</a>
          </s:if>
          <s:else>---
          </s:else>
          </td>
