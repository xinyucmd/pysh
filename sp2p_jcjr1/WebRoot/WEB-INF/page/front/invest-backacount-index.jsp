...
<div class="nymain">
  <div class="wdzh">
    ...
    <div class="r_main">
      <div class="tabtil">
        <ul><li id="lab_1" onclick="jumpUrl('homeBorrowInvestList.do?nav=homeBorrowInvestList');">成功借出</li>
        <li id="lab_2"  onclick="jumpUrl('homeBorrowTenderInList.do?nav=homeBorrowInvestList');">招标中的借款</li>
        <li id="lab_3" onclick="jumpUrl('homeBorrowRecycleList.do?nav=homeBorrowInvestList');">回收中的借款</li>
        <li id="lab_4" onclick="jumpUrl('homeBorrowRecycledList.do?nav=homeBorrowInvestList');">已回收的借款</li>
        <li id="lab_5" class="on" onclick="jumpUrl('homeBorrowBackAcountList.do?nav=homeBorrowInvestList');">回账查询</li>
        </ul>
        </div>
<div class="box">
        <div class="boxmain2">
...
<%--    	<a href="protocol.do?typeId=1&&borrowId=${bean.borrowId }&&investId=${bean.investId }&&styles=1" target="_blank">查看协议</a>--%>
    	<form action="protocol.do" id="form<s:property value='#s.count'/>" method="post" target="_blank">
	          ...
	          <input type="hidden" name ="styles" value="${bean.encStyles }"/>
...
function showAgree(borrowId,invest_id){
    var url = "protocol.do?typeId=15&&borrowId="+borrowId+"&&investId="+invest_id+"&&styles=1";
