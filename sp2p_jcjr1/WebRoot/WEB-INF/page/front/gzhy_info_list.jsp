...
<%--              <a href="userMeg.do?id=${tcmoduleId}">--%>
              <shove:img  defaulImg="images/default-img.jpg" src="${personalHead}" width="62" height="62"  ></shove:img>
<%--              </a>--%>
              <br/>
<%--              <a href="userMeg.do?id=${tcmoduleId}">--%>
              ${aausername }
<%--              </a>--%>
              <br/>
              <a onclick="deleteFriend('${bean.encUserId}','${bean.enTcmoduleId}')"  class="sc">[删除]</a>
            </li>
          </s:iterator>
         </s:else>
         </ul>
