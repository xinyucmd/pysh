...
<div class="nymain">
  ...
  <tr>
    <td colspan="2" align="center">绑定身份证、手机号码即可成为${sitemap.siteName}理财人</td></tr>
  <tr>
  ...
  <tr>
    <td colspan="2" align="left" style="line-height:26px; padding-top:15px; color:#888;">注意：若第一次验证失败，即姓名与身份证号码不匹配。   第二次验证，将按审核成本5元/次的标准收取验证费，请务必填写您的真实信息！进行手机绑定后，本手机号将作为${sitemap.siteName}和您确认贷款的途径之一，请使用您常用的手机号码进行绑定，您的手机号码不会以任何形式被泄露。</td>
    </tr>
    </table>
</form>
    </div>
		  ...
		  var tipId;
		   ...
		   $(function(){
		       $("#clickCode").click(function(){
                   ...
                   }else if((!/^13,5,7,8]\d{9}$/.test($("#cellPhone").val()))){ 
                      $("#u_cellPhone").attr("class", "formtips onError");
