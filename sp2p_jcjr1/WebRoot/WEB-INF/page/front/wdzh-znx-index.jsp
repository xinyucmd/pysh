...
<div class="wrap" style="padding-top:10px;">
    <div class="lne_cent">
        ...
        <div class="lne_centr">
           <!--还款情况--> 
           <p class="lne-centr-con-title" style="font-size:15px; margin-top:0;">
              <i class="p-arrow1 icon11"></i>
              <i class="blue-color">微信贷温馨提示：</i>您当前有<em class="red"></em>信息未读
            </p>
            <div class="lne-centr-con">
                <div class="lne-centr-con-content" id="sysInfo">
                </div>
            </div>
        </div>
    </div>
