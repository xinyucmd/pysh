...
<div class="sqdk" style="background: none;">
	<div class="l-nav">
    <ul><li><a href="querBaseData.do"><span>step1 </span> 基本资料</a></li>
    <li><a href="userPassData.do"><span>step2 </span> 上传资料</a></li>
    <li class="on last"><a href="javascript:void(0);"><span>step3 </span> 申请额度</a></li>
    </ul>
    </div>
    <div class="r-main">
    <div class="rmainbox">
...
$(function(){
	//$("#zq_hover a").removeClass('nav_first');
	//$("#jk_hover a").addClass('class','nav_first');
