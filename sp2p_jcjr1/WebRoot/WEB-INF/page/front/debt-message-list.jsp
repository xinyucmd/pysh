...
<%--          <a href="userMeg.do?id=${message.userId}" target="_blank">--%>
          <img src="<s:property value="#message.personalHead"/>" width="62" height="62" />
<%--          </a>--%>
          </div>
          <div class="lyinfo">
    ...
    <div class="page" style=" padding-top:20px;">
      ...
      <input type="text" class="inp100x" name="paramMap.code" id="code"/>
		 <img src="" title="点击更换验证码" style="cursor: pointer;"
		 	  id="codeNums" width="46" height="18" onclick="javascript:switchCodes()" />
...
function switchCodes(){
	    ...
	    $('#codeNums').attr('src','${sitemap.adminUrl}/imageCode.do?pageId=msg&d='+timenow);
};	
</script>