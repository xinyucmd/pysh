	...
	<div class="lne_centr s_centr">
    	  <!--标题-->
      	 <div class="myhome_tit tab_meun">
	        ...
	        <li class="on" onclick="goUrl('queryAuctedDebt.do');">已转出的债权</li>
         ...
         <div class="myhome_content tab_content clearfix">
              <div>
                   ...
                   <table width="100%" border="0" cellspacing="0" cellpadding="0" class="zh_table" style="margin-top:10px;">
                     ...
                     <!--分页器 开始-->
                     <div class="page">
				    	<shove:page url="queryAuctedDebt.do" curPage="${pageBean.pageNum}" showPageCount="10" pageSize="${pageBean.pageSize }" theme="number" totalCount="${pageBean.totalNum}">
