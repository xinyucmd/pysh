...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tbody><tr>
    <th colspan="2" align="left">收件人：<span id="user"></span></th>
  </tr>
  <tr>
    <th >标题：</th>
  ...
  <tr>
    ...
    <td><input name="input" type="text" name="paramMap.code" id="cod" class="inp90" value="${paramMap.code}"/>
       <img src="${sitemap.adminUrl}/imageCode.do?pageId=code" title="点击更换验证码" style="cursor: pointer;"
		 	  id="codeNum2" width="46" height="18" onclick="javascript:switchCode()"/><br/>
...
function switchCode(){
	    ...
	    $("#codeNum2").attr("src","${sitemap.adminUrl}/imageCode.do?pageId=code&d="+timenow);
};	
</script>
</body>
</html>
