...
<div class="lne_cent">
            	...
            	<div style="background:#fff;padding-bottom:5px; margin-bottom:10px;">
                     <div class="myhome_tit tab_meun">
                        <ul>
                            ...
                            <li class="on" style="width:154px; *width:152px;" onclick="jumpUrl('queryBorrowInvestorInfo.do');">借款明细账</li>
        ...
        <div class="mg-height">
          <form action="queryBorrowInvestorInfo.do" id="searchForm" method="post" class="form-inline">
           <div class="form-group">
               <label >投资者：</label>
 
          <input type="text"  id="investor" name="investor" value="${paramMap.investor}" class="form-control" style="height:28px;"/>
                  </div>
