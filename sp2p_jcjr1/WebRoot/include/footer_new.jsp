...
<div class="p_footerbox index-main">
    ...
    <div class="p_footer">
        <div class="p_footer01">
            <div class="p_ft001"><a href="index.jsp"><img src="images/p_ico030.png" style="margin-top:50px;" /></a></div>
            <div class="p_ft004">
                <p class="p_ft006"><img src="images/p_ico033.png" /> 400-001-6007</p>
                <p style="margin:20px 0 0 26px;"><em style="list-style:none; color:#999; font-size:16px;">服务时间：(9:00-21:00)</em></p>
            </div>
            <div class="p_ft008">
       	    	<img src="images/wx.jpg" width="117" height="117" />
            </div>
            <div class="p_ft002">
                <dl>
                    <dt>关于我们</dt>
...
<div class="p_footer03 clearfix">
        	<div style="width:1100px; margin:0 auto;">
                ...
                <div class="p_ft007" align="center"><span>${sitemap.companyName}</span> <span>版权所有2015copyright reserved 2015</span><span>微信贷&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;京ICP备&nbsp;&nbsp;${sitemap.certificate }</span>
                </div>
            </div>
        </div>
    </div>
