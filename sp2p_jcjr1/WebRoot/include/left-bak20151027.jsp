  ...
  <div class="lne_centl">
        ...
        <div class="lne_l2">
        	<!--<table width="240" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr height="5"></tr>
                <tr height="30">
                	<td><b id="user_account"></b></td>-->
                    <!-- <td><b>${accmountStatisMap.usableAmount}元</b></td> -->
                   <!-- <td ><input onclick="javascript:window.location.href='rechargeInit.do'" type="button" value="充值" /></td>
                </tr>
            </table>-->
            
            <ul>
            	<li style="font-weight: bold;  font-size: 14px;margin-bottom: 5px;">可用余额</li>
                <li><p><b id="user_account"></b></p><p style="float:left;"><input onclick="javascript:window.location.href='rechargeInit.do'" type="button" value="充值"  /></p></li>
            </ul>
        ...
        <li>
          ...
          <li class="level1">
        	...
        	<ul class="level2">
            	...
            	<li id="li_6"><a href="bespeakInvest.do">预约投标</a></li>
            ...
            <li class="level1">
	            <h2>推荐好友</h2>
	        	<ul class="level2">
	            	<li id="li_12"><a href="toReconmmendInfo.do">我的推荐</a></li>
                    <li id="li_13"><a href="toRewardInfo.do">我的奖励</a></li>
	            </ul>
            </li>
           </ul>
        </div>
