...
public interface PartnerConfig{
    ...
    // MD5 KEY
    String MD5_KEY        = "201504231000296502jcbanking";
    // 接收异步通知地址
    String NOTIFY_URL     = "http://www.jcbanking.com/lianlianNotify.do";
    // 支付结束后返回地址
    String URL_RETURN     = "http://www.jcbanking.com/home.do";
    // 商户编号
    String OID_PARTNER    = "201504231000296502";
    // 签名方式 RSA或MD5
