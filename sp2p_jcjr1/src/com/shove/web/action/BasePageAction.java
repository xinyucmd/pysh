...
public class BasePageAction<T> extends BaseAction {
	...
	private static Log log = LogFactory.getLog(BasePageAction.class);
	private static final Pattern regex = Pattern.compile("^([1-9]{1}[0-9]{0,})$");//验证每页显示的条数
	public PageBean<Map<String,Object>> pageBean;//存放分页信息
	//PrintWriter打印输出
	...
	public BasePageAction() {
		if(classType!=null){
			log.info("=================T:"+classType.getClass());
		}
		this.pageBean = new PageBean<Map<String,Object>>(10);
	}

	public PageBean<Map<String,Object>> getPageBean() {
	...
	public void setPageBean(PageBean<Map<String,Object>> pageBean) {
