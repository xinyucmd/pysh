...
//    	User user = (User) session().getAttribute(IConstants.USER_SESSION);
...
//     	}
    	...
    	//根据path参数，设置各路径和URL
    	String path = request.getString("path") != null ? request.getString("path") : "";
    	...
    	String order = request.getString("order") != null ? request.getString("order").toLowerCase() : "name";
