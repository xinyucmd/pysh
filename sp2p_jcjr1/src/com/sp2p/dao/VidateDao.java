...
public class VidateDao {
	 ...
	 */
	public Map<String, String> querymaterialsauth(Connection conn, long id)
			throws SQLException, DataException {
		Dao.Tables.t_materialsauth materialsauth = new Dao().new Tables().new t_materialsauth();

		DataSet dataSet = materialsauth.open(conn, "", "userId = " + id, "",
				-1, -1);
	...
	public Map<String, String> querymaterialsauth(Connection conn, long id,
			Integer type) throws SQLException, DataException {
		Dao.Tables.t_materialsauth materialsauth = new Dao().new Tables().new t_materialsauth();

		DataSet dataSet = materialsauth.open(conn, "", "userId = " + id
				+ " AND materAuthTypeId = " + type, "", -1, -1);
		return BeanMapUtils.dataSetToMap(dataSet);
	}
	 ...
	 * @throws DataException
	 */
	public Map<String, String> queryrequestCredit(Connection conn, long tcid)
			throws SQLException, DataException {
	 ...
	 * @throws DataException
	 */
	public Map<String, String> queryServiceName(Connection conn)
			throws SQLException, DataException {
		return null;
	}
	 ...
	 * @throws SQLException
	 */
	public Long updateUserCreditLimit(Connection conn, Long userId,
			Integer Creditstatus, BigDecimal applyAmount, String checkMsg,
			Long adminId, Long ti) throws SQLException, DataException {
		Long resul = -1L;
		Dao.Tables.t_user user = null;
//		Dao.Tables.t_crediting tcrediting = null;
		BigDecimal preCreditLimit = null;
		BigDecimal usableCreditLimit = null;// 可用信用额度
		Map<String, String> map = new HashMap<String, String>();
		try {
			user = new Dao().new Tables().new t_user();
//			tcrediting = new Dao().new Tables().new t_crediting();
			DataSet dataSet = user.open(conn, "creditLimit,usableCreditLimit",
					" id = " + userId, "", -1, -1);
	 ...
	 * @throws SQLException 
	 */
	public Long upTCREDITING(Connection conn, Long userId,
			Integer Creditstatus, BigDecimal applyAmount, String checkMsg,
			Long adminId, Long ti) throws SQLException{
		Dao.Tables.t_crediting crediting = new Dao().new Tables().new t_crediting();
		crediting.status.setValue(Creditstatus);
		crediting.checkMsg.setValue(checkMsg);
		crediting.reviewer.setValue(adminId);
	 ...
	 * @throws DataException
	 */
	public List<Map<String, Object>> queryMeterAuthTypeListByIds(
	 ...
	 * @throws DataException
	 */
	public List<Map<String, Object>> queryServiceNameByI(Connection conn)
			throws SQLException, DataException {
	 ...
	 * @throws DataException
	 */
	public Map<String, String> queryPerUserCredit(Connection conn, long id)
			throws SQLException, DataException {
	 ...
	 * @throws DataException
	 */
	public Map<String, String> queryPerAdminCredit(Connection conn, long id)
			throws SQLException, DataException {
		Dao.Views.v_t_admin_credit_msg msg = new Dao().new Views().new v_t_admin_credit_msg();
		DataSet dataSet = msg.open(conn, "", " id = " + id, "", -1, -1);
		return BeanMapUtils.dataSetToMap(dataSet);
	}
	 ...
	 * @throws DataException
	 */
	public Map<String, String> queryPerPictruMsgCallBack(Connection conn,
			long id, Integer materAuthTypeId, Long tmtId) throws SQLException,
			DataException {
		Dao.Views.v_t_per_picture msg = new Dao().new Views().new v_t_per_picture();
		DataSet dataSet = msg.open(conn, "", " id = " + id
				+ " AND materAuthTypeId = " + materAuthTypeId + " AND tmdid = "
				+ tmtId, "", -1, -1);
		return BeanMapUtils.dataSetToMap(dataSet);
	}
	 ...
	 * @throws SQLException
	 */
	public List<Map<String, Object>> queryUserCreditCount(Connection conn,
		...
		realName=com.shove.web.Utility.filteSqlInfusion(realName);
		serviceManName=com.shove.web.Utility.filteSqlInfusion(serviceManName);
		...
		if (null != auditStatus && auditStatus > -1) {
			...
			if (certificateName==-1) {
				condition.append(" and tmIdentityauditStatus = "+auditStatus+" or  tmworkauditStatus = "+auditStatus+" or tmaddressauditStatus = "+auditStatus+"  or tmresponseauditStatus  = "+auditStatus+" or tmincomeeauditStatus = "+auditStatus+" ");
			}
		...
		DataSet ds = vtcm
				.open(
						conn,
						"tmIdentityauditStatus,tmworkauditStatus,tmaddressauditStatus,tmresponseauditStatus,tmincomeeauditStatus",
	 ...
	 *            单个证件id
	 */
	public void deletecertificate(Connection conn, Long tmdid)
			throws SQLException {
	 ...
	 * @throws DataException
	 */
	public List<Map<String, Object>> queryPerUserPicturMsg(Connection conn,
			Long id, Integer materAuthTypeId) throws SQLException,
			DataException {
	 ...
	 * @throws DataException
	 */
	public List<Map<String, Object>> querySelectPictureDate(Connection conn,
			Long id, Integer materAuthTypeId) throws SQLException,
			DataException {
	 ...
	 * @throws DataException
	 */
	public Map<String, String> queryBaseDataById(Connection conn, long id)
			throws SQLException, DataException {
	 ...
	 * @throws DataException
	 */
	public Map<String, String> queryUserNameById(Connection conn, long id)
			throws SQLException, DataException {
	 ...
	 * @throws DataException
	 */
	public Map<String, String> queryWorkDataById(Connection conn, long id)
			throws SQLException, DataException {
	 ...
	 * @throws DataException
	 */
	public Map<String, String> queryWork(Connection conn, long id)
			throws SQLException, DataException {
		Dao.Tables.t_workauth workauth = new Dao().new Tables().new t_workauth();
		DataSet dataSet = workauth.open(conn, "", " userId=" + id, "", -1, -1);
		return BeanMapUtils.dataSetToMap(dataSet);
	 ...
	 * @throws DataException
	 */
	public Map<String, String> queryselectpicture(Connection conn, long id)
			throws SQLException, DataException {
		Dao.Views.v_t_user_selectpicture selectpicture = new Dao().new Views().new v_t_user_selectpicture();
		DataSet dataSet = selectpicture.open(conn, "", " id = " + id, "", -1,
				-1);
		return BeanMapUtils.dataSetToMap(dataSet);
	}
	 ...
	 * @throws DataException
	 */
	public Map<String, String> querySelectCledit(Connection conn, long id)
			throws SQLException, DataException {
	 ...
	 * @throws DataException
	 */
	public Map<String, String> queryAllWorkStatus(Connection conn, Long userId)
			throws SQLException, DataException {
		DataSet dataSet = MySQL
				.executeQuery(
						conn,
						"select  (tw.auditStatus+tw.directedStatus+tw.otherStatus+tw.moredStatus) as 'audi' from t_workauth tw where tw.userId = "
								+ userId);
		return BeanMapUtils.dataSetToMap(dataSet);
	}
	 ...
	 * @throws DataException
	 */
	public Map<String, String> querydistribute(Connection conn)
			throws SQLException, DataException {
		DataSet dataSet = MySQL
				.executeQuery(
						conn,
						"select IFNULL(COUNT(*) ,0) as cou from t_user tuser where tuser.adminId is  null");
		return BeanMapUtils.dataSetToMap(dataSet);
	}
	 ...
	 * @throws DataException
	 */
	public List<Map<String, Object>> querySelectCleditList(Connection conn,
		...
		DataSet dataSet = select.open(conn, "", condition.toString(), "", -1,
				-1);
		dataSet.tables.get(0).rows.genRowsMap();
		condition = null;
		return dataSet.tables.get(0).rows.rowsMap;
	 ...
	 * @throws DataException
	 */
	public Map<String, String> queryTotaPass(Connection conn, Long userId)
			throws SQLException, DataException {
		DataSet dataSet = MySQL
				.executeQuery(
						conn,
	 ...
	 * @throws DataException
	 */
	public Map<String, String> querySelectPassTotal(Connection conn, Long userId)
			throws SQLException, DataException {
		DataSet dataSet = MySQL
				.executeQuery(
						conn,
	 ...
	 * @throws DataException
	 */
	public Map<String, String> queryUserTelMsg(Connection conn, Long userId,Long tpiid)
			throws SQLException, DataException {
	...
	public List<Map<String, Object>> querytelphone1(Connection conn)
			throws SQLException, DataException {
		StringBuffer sql = new StringBuffer();
		sql
				.append(" select tuser.id as id, tuser.username as username, a.co as amountall,tp.realName as realName, ");
		sql
	...
	public List<Map<String, Object>> querytelphone2(Connection conn)
			throws SQLException, DataException {
		StringBuffer sql = new StringBuffer();
		sql
				.append(" select tuser.id as id, tuser.username as username, a.co as amountall,tp.realName as realName, ");
	 ...
	 * @throws SQLException
	 */
	public Long updatePersonauditStatus(Connection conn, Long userId,
			Long personId, Integer auditStatus) throws SQLException {
		Dao.Tables.t_person person = new Dao().new Tables().new t_person();
		if (null != auditStatus) {
			// 审核通过
			person.auditStatus.setValue(auditStatus);
		}
		return person.update(conn, " 1 = 1 AND userId = " + userId
				+ " AND id = " + personId);
	}
	...
	public Long updateUserPhone(Connection conn, Long userId, String newTelNumber)
			throws SQLException {
		/*Dao.Tables.t_person person = new Dao().new Tables().new t_person();
		...
		t_user.mobilePhone.setValue(newTelNumber); 
		t_user.update(conn, " id = " + userId); 
		return person.update(conn, " userId = " + userId);
		/*Dao.Tables.t_phone_binding_info tpi = new Dao().new Tables().new t_phone_binding_info();
		if (null != auditStatus && auditStatus != -1) {
			// 审核通过
			tpi.status.setValue(auditStatus);
			tpi.option.setValue(option);
			tpi.update(conn, "  userId = " + userId);
			if (auditStatus == 1) {
				person.cellPhone.setValue(newTelNumber);
	 ...
	 * @throws SQLException
	 */
	public Long updataUserServiceMan(Connection conn, Long userId,
			Integer servicePersonId) throws SQLException {
		Dao.Tables.t_user user = new Dao().new Tables().new t_user();
	...
	/**
	 * 更新用户的工作信息的状态 必须是基本信息通过 和 工作信息 联系
	 * 
	 * @param conn
	 * @param userId
	 * @param personId
	 ...
	 * @throws DataException
	 */
	public Long updateworkStatus(Connection conn, Long userId, Long workauthId,
			Integer auditStatus, Integer directedStatus, Integer otherStatus,
			Integer moredStatus) throws SQLException, DataException {
		...
		Dao.Tables.t_person person = new Dao().new Tables().new t_person();
		try {
			DataSet userds = use.open(conn, "creditrating", " id = " + userId,
					"", -1, -1);
		...
		if (workauthId != null && userId != null) {
			stringBuffer.append("AND id = " + workauthId + " AND userId = "
					+ userId);
		}
		if (auditStatus != 1 && auditStatus != null) {
			...
			if (auditStatus == 3){
				...
				use.creditrating.setValue( precreditrating-10);
				result = use.update(conn, " id = " + userId);// 更新用户的信用积分
				result = addserintegraldetail(conn, userId,10, 
		...
		if (directedStatus != 1 && directedStatus != null) {
			workauth.directedStatus.setValue(directedStatus);
			// ===================================
			if (directedStatus == 3) {
				// 当审核基本信息和 工作信息通过时候 用户的信用分增加 10 分 默认
					use.creditrating.setValue(10 + precreditrating);
					result = use.update(conn, " id = " + userId);// 更新用户的信用积分
					result = addserintegraldetail(conn, userId,10, 
							"用户基本资料审核", 1 ,"用户基本资料审核", "增加");
		...
		if (otherStatus != 1 && otherStatus != null) {
			workauth.otherStatus.setValue(otherStatus);
			// ===================================
			if (otherStatus == 3) {
				// 当审核基本信息和 工作信息通过时候 用户的信用分增加 10 分 默认
					use.creditrating.setValue(10 + precreditrating);
		...
		if (moredStatus != 1 && moredStatus != null) {
			workauth.moredStatus.setValue(moredStatus);
			if (moredStatus == 3) {
				// 当审核基本信息和 工作信息通过时候 用户的信用分增加 10 分 默认
					use.creditrating.setValue(10 + precreditrating);
					result = use.update(conn, " id = " + userId);// 更新用户的信用积分
	 ...
	 * @throws DataException
	 */
	public Long Updatematerialsauth(Connection conn, Long mtId, Long userId,
			Long materAuthTypeId, String option, Integer auditStatus,
			Long materaldetalId, Integer visiable) throws SQLException,
			ParseException, DataException {
		Dao.Tables.t_materialimagedetal materialImagedetal = new Dao().new Tables().new t_materialimagedetal();
		...
		result1 = materialImagedetal.update(conn, " materialsauthid = " + mtId
				+ " AND id = " + materaldetalId);
		if (result1 <= 0) {
			return -1L;
		}
		return result1;
	...
	public Long Updatecreditrating(Connection conn, Long userId,
			String alloption, Integer creditrating, Long adminId,
			Integer mterType, Integer checkStatus) throws SQLException,
			Exception {
		...
		try {
			...
			mads = materialsauth.open(conn, "criditing,auditStatus",
					" userId = " + userId + " AND materAuthTypeId = "
							+ mterType, "", -1, -1);
		...
		if (StringUtils.isNotBlank(alloption) && mterType != null
			...
			if (checkStatus == 3) {
				...
				//materialsauth.criditing.setValue( preTyperating-creditrating);// 当前信用积分减去传来的信用积分
				materialsauth.criditing.setValue( 0);
				materialsauth.option.setValue(alloption);
				materialsauth.authTime.setValue(new Date());// 审核时间
		...
		if (creditrating != null && creditrating != -1 && precreditrating != -1 && checkStatus == 3) {
			user.creditrating.setValue(creditrating + precreditrating);// 当前的信用积分加上后台添加的信用分数
			resut2 = user.update(conn, " id = " + userId);// 更新信用分
			resut2 = addserintegraldetail(conn, userId,creditrating, 
					"用户基本资料审核",1, "用户基本资料审核",changeType);
			if (resut2 > 0) {
				flag = true;
			} else {
				flag = false;
		...
		if (creditrating != null && creditrating != -1 && precreditrating != -1 && checkStatus == 2) {
			user.creditrating.setValue(precreditrating - preTyperating);// 
			resut2 = user.update(conn, " id = " + userId);// 更新信用分
			resut2 = addserintegraldetail(conn, userId,preTyperating, 
					"用户基本资料审核",1, "用户基本资料审核", "减少");
			if (resut2 > 0) {
				flag = true;
			} else {
	...
	public Long addCheckRecord(Connection conn, Integer creditrating,
			Long adminId, Long userId, Integer mterType, Integer cCreditration)
			throws SQLException {
		Long result = -1L;
		...
		try {
			DataSet ds = materialsauth
					.open(conn, "criditing,auditStatus", " userId =" + userId
		...
		if (map.size() > 0 && map != null) {
			...
			auditStatus= Convert.strToInt(map.get("auditStatus"), -1);
		}
		if(auditStatus==2&&precreditrating != -1){
			check.perrecode.setValue(cCreditration);// 设置原来的信用分数
			check.afterrecode.setValue(0);
	 ...
	 * @throws SQLException
	 */
	public Long addeducationcost(Connection conn, Long userId,
			String educationFree) throws SQLException {
	 ...
	 * @throws DataException
	 */
	public List<Map<String, Object>> queryAdminCheckList(Connection conn,
			Long userId, Integer materAuthTypeIdStr) throws SQLException,
			DataException {
		Dao.Views.v_t_user_adminchecklist adminchecklist = new Dao().new Views().new v_t_user_adminchecklist();
		DataSet dataSet = adminchecklist.open(conn, "", " 1 = 1 AND userId = "
				+ userId + " AND materialType = " + materAuthTypeIdStr, "", -1,
				-1);
		dataSet.tables.get(0).rows.genRowsMap();
		return dataSet.tables.get(0).rows.rowsMap;
	}
	 ...
	 * @throws SQLException
	 */
	public Long updataUserServiceMans(Connection conn, String ids,
			String admins) throws SQLException{
		String[] allIds = ids.split(",");
		String[] allAdmins = admins.split(",");
		int count = 0;
		long result = -1L;
		for(int i=0,n=allIds.length;i<n;i++){
			result = Database.executeNonQuery(conn,
					" update t_user set adminId = "+allAdmins[i] 
					+" where id=" + allIds[i]);
			if(result > 0){
				count ++;
			}
	...
	public long Updatecreditrating2(Connection conn, Long userId,Integer auditStatus,
			Integer creditrating, Integer mterType) throws SQLException {
		Dao.Tables.t_materialsauth materialsauth = new Dao().new Tables().new t_materialsauth();
		materialsauth.auditStatus.setValue(null);
		materialsauth.criditing.setValue( 0);
		return materialsauth.update(conn, " userId = " + userId
				+ " AND materAuthTypeId = " + mterType);
		
	}
	public long Updatecreditrating1(Connection conn, Long userId,Integer auditStatus,
			Integer creditrating, Integer mterType) throws DataException, SQLException {
		DataSet ds = null;
		DataSet mads = null;
		Integer precreditrating = -1;// 原来的总信用积分
		Integer preTyperating = -1;// 原来的证件单个信用积分
		...
		ds = user.open(conn, "creditrating", " id = " + userId, "", -1, -1);
		mads = materialsauth.open(conn, "criditing,auditStatus", " userId = "
				+ userId + " AND materAuthTypeId = " + mterType, "", -1, -1);
		map = BeanMapUtils.dataSetToMap(ds);
		nmap = BeanMapUtils.dataSetToMap(mads);
		if (map != null && map.size() > 0 && nmap.size() > 0 && nmap != null) {
			precreditrating = Convert.strToInt(map.get("creditrating"), 0);
		...
		materialsauth.criditing.setValue( 0);
		user.creditrating.setValue(precreditrating - preTyperating);// 
		user.update(conn, " id = " + userId);// 更新信用分
		 addserintegraldetail(conn, userId,preTyperating, 
					"用户基本资料审核",1, "用户基本资料审核", "减少");
		return materialsauth.update(conn, " userId = " + userId
				+ " AND materAuthTypeId = " + mterType);
	 ...
	 * @throws Exception
	 */
	public long updateSatues(Connection conn, Long userId,Long multType) throws SQLException,Exception {
		Dao.Tables.t_materialsauth materialsauth = new Dao().new Tables().new t_materialsauth();
		materialsauth.auditStatus.setValue(3);//审核状态
		materialsauth.option.setValue("通过");
		materialsauth.authTime.setValue(new Date());// 审核时间
		return materialsauth.update(conn, " userId = " + userId + " AND materAuthTypeId = " + multType);
	}
