...
public class SEOConfigDao {
	...
	public long  updateOptions(Connection  conn,long id,int app_state) throws SQLException, IOException, DataException{
		Dao.Tables.t_options options = new Dao().new Tables().new t_options();
		options.app_state.setValue(app_state);
		return options.update(conn, "id="+id);
