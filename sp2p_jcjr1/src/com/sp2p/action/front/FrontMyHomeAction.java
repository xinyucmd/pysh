...
//		
	...
	/**
	* @Description: 微信端个人账户信息
	* @author liugang
	* @date 2016年8月8日 上午9:28:43
	 */
	public String homeInitWX() throws Exception {
		User user = (User) session().getAttribute("user");
		JSONObject json = new JSONObject();
		/**当前账户金额基本信息*/
		Map<String, String> accmountStatisMap = myHomeService.queryAccountStatisInfo(user.getId());
		json.put("accmountStatisMap", accmountStatisMap);
		JSONUtils.printObject(json);
		return null;
	}
	public String indexWX() throws Exception {
		return "success";
	}
	/**
