...
public class EconomyAction extends BasePageAction {
	...
	public String addEconomy() throws Exception {
		...
		long roleId = IConstants.ADMIN_ROLE_ECONOMY;// 经纪人角色默认为2
	...
	public String queryEconomyInfo() {
		...
		String userName2 = request.getString("userName2");
		String realName2 = request.getString("realName2");
...
//			if(Integer.parseInt(parentList.get(i).get("id").toString())!=admin.getId()){
//				parentList.remove(i);
//			}
//		}
		return parentList;
