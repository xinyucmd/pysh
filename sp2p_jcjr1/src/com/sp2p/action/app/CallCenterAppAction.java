...
//			callCenterService.queryAllAnswerLists(IConstants.SORT_TYPE_DESC, pageBean,typeId);
	 ...
	 * @throws Exception
	 */
	public String versionUpdate() throws Exception{
		Map<String, Object> jsonMap = new HashMap<String, Object>();
		try{
			String web_app_version = IConstants.WEB_APP_VERSION;
			String web_app_url = IConstants.WEB_APP_URL;
			jsonMap.put("web_app_version",web_app_version);
			jsonMap.put("web_app_url",web_app_url);
			jsonMap.put("error", "-1");
			jsonMap.put("msg", "成功");
			JSONUtils.printObject(jsonMap);
		}catch (Exception e) {
