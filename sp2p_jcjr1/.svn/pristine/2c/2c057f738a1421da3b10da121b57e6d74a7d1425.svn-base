...
<div class="tabmain">
  <ul><li >借款协议</li>
   ...
   <!--  <div class="lcmain"> 
    ...
    <h2 style="font-size: 20px">收益权转让及回购合同</h2>
  <p align="right">
	 合同编号: <b><u>P2P—${map.DatesNumber}${map.id }</u></b>
</p>
<p align="right">
	 签约日期: 本合同由如下各方于<b><u>${map.DateTime}</u></b>协商一致，并由微信贷平台自动生成。<br />
</p>
<br />
<!--   
<p>
...
<p>
	转让人: <b>${map.realName} &nbsp;&nbsp;&nbsp; (<shove:sub  value="#request.map.isno" size="12"   suffix="******" />)</b>，以下称“借入方”；
</p>
-->
<p>
 	<h2>转让人（甲方）：${loanMap.name} </h2>
                    住所：<br />
                    邮编：<br />
                    联系电话：<br /><br />
</p>
...
<p>
 <h2>受让人（乙方）：
	...
	<s:elseif test="#request.user_invest_map.size>1">
	    <s:iterator var="mapBeans" value="#request.user_invest_map" >
		           <s:if test="%{#mapBeans.realName==''}">${mapBeans.username};</s:if>
			       <s:else>${mapBeans.realName};</s:else>
	    </s:iterator>
	...
	<s:else>
 	 ...
 	 <s:if test="#request.states==0">
	               联系人手机： ${userMaps.mobilePhone } </br>   
	               身份证号码：${userMaps.idNo }</br>   
	 </s:if>
	 </br>   
...
<p>
	<h2>担保人（丙方）：${bondingMap.bonding_name}</h2>
                    住所地：<br />
                    法定代表人：<br />
                    联系电话：<br />
                    邮箱：<br /><br />
...
<p>
	<!-- 管理方: <b><u>${sitemap.siteName}</u></b>，以下称“管理方”。-->
	
	<h2>微信贷平台（丁方） : 江川金融信息服务（北京）股份有限公司</h2>
	          住所：北京市海淀区西直门北大街56号生命人寿大厦7层，邮编：100082<br />
	          网址：www.jcbanking.com<br />
                    联系电话：400-001-6007<br />
                    邮箱：bd@jiangchuanbanking.com
	...
	<tbody>
		<tr>
			<td  valign="middle" style="border:solid black 1.0pt;background:#D9D9D9;">
				<p>
					<span style="font-family:宋体;color:windowtext;">受让人名称</span><span style="font-family:&quot;color:windowtext;"></span>
				</p>
			</td>
			<td  width="180px;" valign="top" style="border:solid black 1.0pt;background:#D9D9D9;">
				<p>
					<span style="font-family:宋体;color:windowtext;">受让金额</span><span style="font-family:&quot;color:windowtext;">(</span><span style="font-family:宋体;color:windowtext;">人民币</span><span style="font-family:&quot;color:windowtext;">)</span>
				</p>
			</td>
			<td  width="180px;" valign="top" style="border:solid black 1.0pt;background:#D9D9D9;">
				<p>
					<span style="font-family:宋体;color:windowtext;">受让期限</span><span style="font-family:&quot;color:windowtext;"></span><span style="font-family:宋体;color:windowtext;"></span><span style="font-family:&quot;color:windowtext;"></span>
				</p>
			</td>
				...
				<p>
					...
					<td  width="180px;" valign="top" style="border:solid black 1.0pt;background:#D9D9D9;">
				<p>
					<span style="font-family:宋体;color:windowtext;">受让开始日期</span><span style="font-family:&quot;color:windowtext;"></span><span style="font-family:宋体;color:windowtext;"></span><span style="font-family:&quot;color:windowtext;"></span>
				</p>
			</td>
			
					<td  width="180px;" valign="top" style="border:solid black 1.0pt;background:#D9D9D9;">
				<p>
					<span style="font-family:宋体;color:windowtext;">受让到期日期</span><span style="font-family:&quot;color:windowtext;"></span><span style="font-family:宋体;color:windowtext;"></span><span style="font-family:&quot;color:windowtext;"></span>
				</p>
			</td>
...
<!-- 
	债务人 : <b><u>${map.Busername}</u></b><b><u>(</u></b><b><u>身份证号码：</u></b>
				...
				<td width="397" valign="top" style="border:solid black 1.0pt;background:white;">
					<p>
						<span style="font-family:宋体;color:windowtext;">
					        <s:if test="#request.map.paymentMode==1">按月分期</s:if>
...
<div style="text-align: center;">
     <img src="images/company/srcnh${CODE}.png" alt="点击查看" width="550" height="700"/>
     <!-- 
     <img src="images/company/hgcnh${CODE}.png" alt="点击查看" width="485" height="700"/>
      -->
</div>
