...
public class ShowShipinAdminService extends BaseService {
	 ...
	 * @throws SQLException
	 */
	public Map<String, String> querydateMa1(Long tmid) throws Exception {
	 ...
	 * @throws SQLException
	 */
	public Map<String, String> queryCountMsg( Long typeid,Long userId ) throws Exception {
		Connection conn = MySQL.getConnection();
		Map<String, String> map = null;
		try {
	 ...
	 * @throws SQLException
	 */
	public Map<String, String> queryonemsg( Long tmdid ) throws Exception {
		Connection conn = MySQL.getConnection();
		Map<String, String> map = null;
		try {
	 ...
	 * @throws SQLException
	 */
	public Map<String, String> querytmid( Long typeid,Long userId ) throws Exception {
		Connection conn = MySQL.getConnection();
		Map<String, String> map = null;
		try {
	 ...
	 * @throws SQLException
	 */
	public List<Map<String, Object>> queryCountPictureList(Long tmid) throws Exception {
