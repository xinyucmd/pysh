...
<div class="boxmain2">
	...
	<div class="biaoge2">
		<form id="BaseDataform">
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				...
				<tr>
					<td align="right">
						<span style="color: red; float: none;" class="formtips">*</span>性
						别：
					</td>
					<td>
						<s:if test='#request.flag=="2"'>
    ...
    -->
				...
				<tr>
					<td align="right">
						<span style="color: red; float: none;" class="formtips">*</span>籍
						贯：
					</td>
					<td>
				...
				<tr>
					<td align="right">
						<span style="color: red; float: none;" class="formtips">*</span>居住地址：
					</td>
					<td>
				...
				<tr>
					<td align="right">
						<span style="color: red; float: none;" class="formtips">*</span>居住电话：
					</td>
					<td>
    ...
    - -->
				...
				<tr>
					...
					<td class="tishi">
						...
						<br />
						一旦被发现所填资料有虚假，将会影响您在${sitemap.siteName}的信用，对以后借款造成影响。
					</td>
				</tr>
				<tr>
					<td align="right">&nbsp;
