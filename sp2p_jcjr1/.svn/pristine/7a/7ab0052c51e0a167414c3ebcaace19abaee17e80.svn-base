...
<div class="lne_cent">
  ...
  <tr>
    <td align="right">&nbsp;</td>
    <td class="txt"><strong>注：尊敬的用户，您在${sitemap.siteName}网的相关操作，
    ${sitemap.siteName}网会用以上三种方式<br />通知您，请您选择适合自己的通知方式！
    (系统默认以站内信通知)短信通知每条0.1元。</strong></td>
  </tr>
  <tr>
    <td align="right">&nbsp;</td>
    <td style="padding-top:10px;">
    <a href="javascript:void(0);" class="bcbtn" onclick="addNoteSetting();">确认</a></td>
  </tr>
    </table>
</div>
    </div>
