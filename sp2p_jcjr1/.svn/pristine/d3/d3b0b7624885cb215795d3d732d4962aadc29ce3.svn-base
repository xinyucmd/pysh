...
<div class="lne_cent">
		   ...
		   <div class="lne-centr-con" style="margin-top:10px;">
            	<div style="background:#fff;padding-bottom:5px; margin-bottom:10px;">
                     <div class="myhome_tit tab_meun">
                        <ul>
                            <li class="on" style="width:154px; *width:152px;" onclick="jumpUrl('queryMySuccessBorrowList.do');">成功借款</li>
                            <li style="width:154px; *width:152px;" onclick="jumpUrl('queryMyPayingBorrowList.do');">正在还款的借款</li>
        ...
        <div class="mg-height">
        <form action="queryMySuccessBorrowList.do" id="searchForm" method="post" class="form-inline">
          ...
          <div class="form-group" style="width:178px\9;">
             <label>关键字：</label>
              <input type="text" class="form-control" style="height:28px;" name="title" value="${paramMap.title }" id="title_s" />
          </div>
        <input type="button"  id="btn_search" value="搜 索" class="btn btn-primary" style=" position:relative; right:0;"/>
        <input type="button" value="导出excel表" onclick="excelout()" class="btn btn-primary" style=" position:relative; right:0;"/>
 ...
 <div class="s_foot-page">
    <p>
	     <shove:page url="queryMySuccessBorrowList.do" curPage="${pageBean.pageNum}" showPageCount="10" pageSize="${pageBean.pageSize }" theme="number" totalCount="${pageBean.totalNum}">
