...
<script type="text/javascript">
			$(function(){
				...
				$("#excel").click(function(){
				 window.location.href=encodeURI(encodeURI("exporthasRepay.do?userName="+$("#userName").val()+"&&timeStart="+$("#timeStart").val()+"&&timeEnd="+$("#timeEnd").val()+"&&timeStart1="+$("#timeStart1").val()+"&&timeEnd1="+$("#timeEnd1").val()+"&&deadline="+$("#deadline").val()+"&&borrowWay="+$("#borrowWay").val()));
				});
			});			
