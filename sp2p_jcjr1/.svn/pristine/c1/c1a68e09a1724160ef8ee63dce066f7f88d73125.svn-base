...
<html>
  <head>
    <title>${sitemap.siteName}-登录</title>
						...
						<form action="logining.do" method="post">
							<table width="100%" border="0" cellspacing="0" cellpadding="0">
								...
								<tr>
									...
									<td class="mima">
										<input type="password" class="inp202" name="paramMap.password" id="password" />
								...
								<tr>
									...
									<td class="zctd">
										还没有加入${sitemap.siteName}？										<a href="reg.do">立即注册</a>
									</td>
								</tr>
								<tr>
									<td>&nbsp;
									...
									<td>
										<input type="button" value="登录" class="dlbtn"
											style="cursor: pointer;" id="btn_login" />
									</td>
								</tr>
							</table>
						</form>
