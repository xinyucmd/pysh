...
<html>
	<head>
		...
		<script type="text/javascript" language="javascript">
			...
			//window.open("uploadFileAction.do?obj="+json,window,"width=500px;height=400px");
    ...
    <input type="hidden" name="paramMap.borrowMoneyend" value="${paramMap.borrowMoneyend }"/>
      ...
      <input type="hidden" name="paramMap.aprend" value="${paramMap.aprend }"/>
							...
							<tr>
								...
								<td align="left" class="f66">
									<s:textfield name="paramMap.bigestFlowUnit" theme="simple"
										cssClass="in_text_2" cssStyle="width: 150px" ></s:textfield>
									<span style="color: red;">*<s:fielderror
											fieldName="paramMap['bigestFlowUnit']" />
									</span>
								</td>
							</tr>
							...
							<tr>
								...
								<td align="left" class="f66">
									<s:textfield name="paramMap.maxMoneyValue" theme="simple"
										cssClass="in_text_2" cssStyle="width: 150px" ></s:textfield>
									<span style="color: red;">*<s:fielderror
											fieldName="paramMap['maxMoneyValue']" />
									</span>
								</td>
							</tr>
							<tr>
