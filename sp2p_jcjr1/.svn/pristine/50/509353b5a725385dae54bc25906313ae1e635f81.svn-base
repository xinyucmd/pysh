					...
					<div id="showcontent" style="width: auto; background-color: #FFF; padding: 10px;">
						...
						<td id="secodetble" style="width: 60%" colspan="2">
						  <table  border="0" cellspacing="1" cellpadding="3" width="60%">
							...
							<a style="cursor: pointer;" onclick="javascript:window.location.href='queryUserManageBaseInfoinner.do?i=${userId}';">个人基本信息</a></td><td>&nbsp;</td>
							...
							<a href="queryUserManageInvest.do?i=${userId}" style="cursor: pointer;">投资信息</a>
							</td>
							</tr>
							</table>
							</td>
							...
							单位名称：
								...
								<td align="left" class="f66">			
											<input type="text" name="paramMap.orgName" id="orgName"
														class="inp188" value="${map.orgName}" disabled="disabled"/>
								</td> 							
