    ...
    -->
							...
							<tr>
								...
								<tr>
								  ...
								  <input type="button" style="background-image: url('../images/admin/btn_queding.jpg'); min-width: 70px; border: 0; height: 26px" class="scbtn" id="tb_yes"/>
								</a>
...
$(function(){
  $("#queryMsg").click(function(){
    window.location.href='queryPerUserCreditAction.do?userId=${map.ids }&userId_admin=&publisWay=1';
  });					  
