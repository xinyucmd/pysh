	...
	<head>
		...
		<script type="text/javascript">
			...
			function initListInfo(praData){							    
		 		$.shovePost("queryInfomationListPage.do",praData,initCallBack);
		 	}
			...
			/* function dels(){
		 	...
		 	function del(id){
	 			...
	 			window.location.href= "deleteInfomation.do?id="+id;
		 	}
				...
				<div>
					<table border="0" cellspacing="0" cellpadding="0">
						<tr>
							...
							<td width="100" height="28"  class="xxk_all_a">
								<a href="queryNewsListInit.do">理财知识管理</a>
							</td>
							<td width="2">
								&nbsp;
							</td>
							<td width="100"  class="xxk_all_a">
								<a href="addNewsInit.do">添加理财知识</a>
							</td>
							<td width="2">
								&nbsp;
							</td>
