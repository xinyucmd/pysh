...
public class DownloadAction extends BasePageAction {
	...
	*/
	public String addDownload() throws Exception{
		...
		String content = paramMap.get("content"); //详细内容
		String attachment = paramMap.get("attachment"); //详细内容
	...
	* @throws
	*/
	public String queryDownloadListPage() throws Exception{
	 ...
	 * @throws IOException
	 */
	public String queryDownloadById() throws Exception{
	...
	public String updateDownload() throws Exception{
		...
		String content = paramMap.get("content"); //详细内容
		String attachment = paramMap.get("attachment"); //附件路径
