		...
		<script type="text/javascript" language="javascript">
	    	...
	    	init();
				...
				$("#btn_save").click(function(){
				  if($("#gTip").html()==""){//add by houli，在团队长帐户填写正确的情况下才进行提交
					$(this).hide();
					$("#addAdmin").submit();
					return false;
					}
			...
			if(window.ActiveXObject){
				...
				window.open("uploadFileAction.do?obj="+json,window,"dialogWidth=500px;dialogHeight=400px");
			}
...
function citySelectInit(parentId, regionType){
	...
	<body>
	<form id="addAdmin" action="addGroupCaptain.do" method="post">
			<div id="right">
						...
						<table border="0" cellspacing="0" cellpadding="0">
							<tr>
								<td width="100" height="28" class="xxk_all_a">
									<a href="queryGroupCaptainInit.do">团队长列表</a>
								</td>
								<td width="2">
									&nbsp;
								</td>
								<td width="100"  class="main_alll_h2">
									<a href="addGroupCaptainInit.do">添加团队长</a>
								</td>
								<td width="2">
								&nbsp;
							</td>
						...
						<table width="100%" border="0" cellspacing="1" cellpadding="3">
							<tr>
								...
								<td align="left" class="f66">
									...
									<span id="gTip" style="color: red;" ></span>
								</td>
							</tr>
							<tr>
