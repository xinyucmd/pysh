...
public class GuaranteeService extends BaseService {
	...
	public Map<String,String> queryCreditStatic(long userId) throws Exception{
		Connection conn = MySQL.getConnection();
		Map<String, String> map = new HashMap<String, String>();
		try {
			DataSet ds = new DataSet();
			List<Object> outParameterValues = new ArrayList<Object>();
			Procedures.p_credit_static(conn, ds, outParameterValues, userId);
	 ...
	 * @throws SQLException
	 */
	public Map<String, String> queryUserInformation(Long userId)
			throws Exception {
	 ...
	 * @throws SQLException
	 */
	public Map<String, String> queryPerUserCreditfornt(Long userId)
			throws Exception {
		Map<String, String> map = null;
		StringBuffer condition = new StringBuffer();
		if (userId != null && userId >= -1) {
	 ...
	 * @throws SQLException
	 */
	public Map<String, String> queryUserCredit(Long userId) throws Exception {
		Map<String, String> map = null;
		StringBuffer condition = new StringBuffer();
		if (userId != null && userId >= -1) {
			condition.append(" AND id = " + userId);
	 ...
	 * @throws SQLException
	 */
	public Map<String, String> queryUserVipPicture(Long userId)
			throws Exception {
		Map<String, String> map = null;
		StringBuffer condition = new StringBuffer();
		if (userId != null && userId >= -1) {
	 ...
	 * @throws SQLException
	 */
	public Map<String, String> queryUserCriditPicture(Long userId)
			throws Exception {
		Map<String, String> map = null;
		StringBuffer condition = new StringBuffer();
		if (userId != null && userId >= -1) {
	 ...
	 * @throws Exception
	 */
	public void queryUserFriends(PageBean<Map<String, Object>> pageBean,
		...
		try {
			dataPage(conn, pageBean, sql.toString(), sqlresult.toString(), "",
					" AND tc.moduleType = 1 AND tc.userId = " + userId);
		} catch (Exception e) {
			log.error(e);
			e.printStackTrace();
			throw e;
	 ...
	 */
	public Long DeteleUserFriends(Long attentionUserId, Long userId)
			throws Exception {
		Connection conn = MySQL.getConnection();
		Map<String, String> userMap = new HashMap<String, String>();
		Long reuslt = -1L;
		try {
			reuslt = guaranteeDao.DeteleUserFriends(conn, attentionUserId,
					userId);
			userMap = userDao.queryUserById(conn, userId);
			// 添加操作日志
			operationLogDao
					.addOperationLog(conn, "t_concern", Convert.strToStr(
							userMap.get("username"), ""), IConstants.DELETE,
	 ...
	 * 查询个人统计 借款记录
	 */
	public Map<String, String> queryUserBorrowRecode(Long userId)
			throws Exception {
		Connection conn = MySQL.getConnection();
	 ...
	 * 查询个人统计 投标记录
	 */
	public Map<String, String> queryUserInerseRecode(Long userId)
			throws Exception {
		Connection conn = MySQL.getConnection();
		try {
	 ...
	 * @throws DataException
	 */
	public Map<String, String> queryUserBorrowAndInver15(Long userId)
			throws Exception {
		Connection conn = MySQL.getConnection();
		try {
	 ...
	 * @throws DataException
	 */
	public Map<String, String> queryUserBorrowAndInver16(Long userId)
			throws Exception {
		Connection conn = MySQL.getConnection();
		try {
	 ...
	 * @throws DataException
	 */
	public Map<String, String> queryUserBorrowAndInver10(Long userId)
			throws Exception {
		Connection conn = MySQL.getConnection();
		try {
	 ...
	 * @throws DataException
	 */
	public Map<String, String> queryUserBorrowAndInver30(Long userId)
			throws Exception {
		Connection conn = MySQL.getConnection();
		try {
	 ...
	 * @throws DataException
	 */
	public Map<String, String> queryUserBorrowAndInver90(Long userId)
			throws Exception {
		Connection conn = MySQL.getConnection();
		try {
	 ...
	 * @throws DataException
	 */
	public Map<String, String> queryUserBorrowAndInver90up(Long userId)
			throws Exception {
		Connection conn = MySQL.getConnection();
		try {
	 ...
	 * @throws DataException
	 */
	public void queryMyBorrowList(PageBean<Map<String, Object>> pageBean,
			Long userId) throws Exception {
		Connection conn = MySQL.getConnection();
		try {
			dataPage(conn, pageBean, "v_t_user_myborrowlist", "*", "",
					"  AND uid = " + userId);
		} catch (Exception e) {
			log.error(e);
			e.printStackTrace();
	 ...
	 * @throws DataException
	 */
	public List<Map<String, Object>> queryAllMyborrowRecorde(long userId) throws Exception {
		Connection conn = MySQL.getConnection();
		List<Map<String, Object>> list = null;
		try {
			list = guaranteeDao.queryAllMyborrowRecorde(conn, userId);
		} catch (Exception e) {
			log.error(e);
			e.printStackTrace();
			throw e;
	 ...
	 * @throws DataException
	 */
	public void queryMyborrowRecorde(PageBean<Map<String, Object>> pageBean,
			Long userId) throws Exception {
		Connection conn = MySQL.getConnection();
		try {
			dataPage(conn, pageBean, "v_t_user_myborrowrecorde", "*", "",
					"  AND uid = " + userId);
		} catch (Exception e) {
			log.error(e);
			e.printStackTrace();
	 ...
	 * @throws DataException
	 */
	public void queryUserRecore(PageBean<Map<String, Object>> pageBean,
			Long userId) throws Exception {
		Connection conn = MySQL.getConnection();
		StringBuffer condition = new StringBuffer();
		if (userId != null && userId != -1) {
		...
		try {
			dataPage(conn, pageBean, "t_user_recorelist", "*", " order by id",
					condition.toString());
		} catch (Exception e) {
			log.error(e);
			e.printStackTrace();
	 ...
	 * @throws DataException
	 */
	public void queryfrendsRecore(PageBean<Map<String, Object>> pageBean,
			Long userId) throws Exception {
		Connection conn = MySQL.getConnection();
		StringBuffer condition = new StringBuffer();
		if (userId != null && userId != -1) {
		...
		System.out.println(resulSQl.toString());
		// ======
		StringBuffer sql = new StringBuffer();
		...
		try {
			dataPage(conn, pageBean, sql.toString(), resulSQl.toString(),
					" order by tur.time", condition.toString());
		} catch (Exception e) {
			log.error(e);
			e.printStackTrace();
