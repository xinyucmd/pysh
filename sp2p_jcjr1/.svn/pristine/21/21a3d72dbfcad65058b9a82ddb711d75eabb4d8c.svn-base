...
<div class="tabmain">
  ...
  <tr>
   ...
   <%-- //whb去掉竞拍 <td>拍卖底价：<s:select list="#{1:'3000元以下',2:'3000-5000',3:'5000-10000',4:'1万-2万',5:'2万-5万',6:'5万以上'}" name="auctionBasePrice" value="paramMap.auctionBasePrice" theme="simple" headerKey="" headerValue="全部"></s:select>
      </td>
...
<%--      <a href="userMeg.do?id=${publisher}" target="_blank">--%>
      ${borrowerName }
<%--      </a>--%>
      &nbsp; <img src="images/ico_${creditratingIco }.jpg" title="${creditrating }分" /></td>
