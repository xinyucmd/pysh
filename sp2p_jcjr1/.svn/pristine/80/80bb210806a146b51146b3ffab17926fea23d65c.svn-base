...
public class FrontSuccessStorydAction extends BasePageAction {
	...
	public String frontQuerySuccessStoryList() throws Exception {
	 ...
	 * @throws Exception
	 */
	public String frontQuerySuccessStoryListPage() throws Exception {
		try {
			successStoryService.querySuccessStoryPage(pageBean);
	 ...
	 * @throws Exception
	 */
	public String frontQuerySuccessStoryById() throws Exception {
		...
		try {
			...
			// 浏览次数增加
			successStoryService.updateSuccessStory(id, null, null, null, null,
					null, Convert.strToLong(paramMap.get("browseNum"), -1) + 1,
					null);
