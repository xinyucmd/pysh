				...
				<div style="padding: 15px 10px 0px 10px;">
					<div>
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr>
								<td width="100" height="28" bgcolor="#CC0000" align="center" bgcolor="#8594A9"
									class="main_alll_h2">
									借款审核满标复审
								</td>
								<td width="2">
					...
					<div class="tab">
						<table cellspacing="1" cellpadding="3">
							...
							<tr>
								<td class="blue12 left">
									...
									<s:if test="%{borrowMFullScaleDetail.isDayThe ==1}">个月</s:if><s:else>天</s:else>
								</td>
								<td class="f66 leftp200">
							...
							<tr>
								<td class="blue12 left">
									...
									<s:elseif test="%{borrowMFullScaleDetail.paymentMode==4}">
									 一次性还款
									</s:elseif>　　
								</td>
								<td class="f66 leftp200">
							...
							<s:else>
									...
									<td class="f66 leftp200">
	                                                                                                最高投标金额：
	                                    <s:if test="%{borrowMFullScaleDetail.maxTenderedSum==-1}">
								                           没有限制
								        </s:if>
								        <s:else>
							...
							<tr>
								<td class="blue12 left">
									投标密码：
									<s:if test="%{borrowMFullScaleDetail.hasPWD ==1}">
									   有
									</s:if>
									<s:else>
									   无
						...
						<s:if test="%{borrowMFullScaleDetail.borrowShow==1}">
							...
							<tr>
								<td colspan="2" class="blue12 left">
									借款人认证审核查看：<a href="queryPerUserCreditAction.do?userId=${borrowMFullScaleDetail.new_userId}&userId_admin=${borrowMFullScaleDetail.new_userId_admin}&publisWay=${borrowMFullScaleDetail.publisherWay}" target="_blank">申请人认证详情查看</a>
								</td>
							</tr>
							<tr>
								<td colspan="2" class="blue12 left">
