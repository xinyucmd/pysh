...
<%--              </a>--%>
              <br/>
             ${sitemap.siteName}信用等级：<img src="images/ico_${investDetailMap.credit}.jpg" title="${investDetailMap.creditrating}分" width="33" height="22" /></div>
              <p class="">
...
线下交易
 ...
 <div class="tbcz">
  <p class="money">
          ...
          <p class="tips">请填写并确认下面投标金额 <!--  <a href="setPwd.do" class="czbtn"><input type="button" value="设置交易密码"/></a>  --> <br/>
