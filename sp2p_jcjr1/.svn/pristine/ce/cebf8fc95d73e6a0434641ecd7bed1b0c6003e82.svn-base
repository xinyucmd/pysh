	...
	<head>
	   ...
	   function initListInfo(praData) {
			...
			param["endDate"] = $("#endDate").val();
	   		$.shovePost("relationLeveladdInfo.do",praData,initCallBack);
   		}
   		...
   		function addRelationkh(){
 			...
 			paramMap["paramMap.level2Id"] = '${level2Id}'//经纪人id
 			$.shovePost("addRelationkhId.do",paramMap,function(data){
 				if(data=='1'){
	 			  	alert("关联成功");
	 			 window.location.href='relationLeveladdInit.do';
	 			}else{
             		alert("关联失败");
	 			}
 			});
