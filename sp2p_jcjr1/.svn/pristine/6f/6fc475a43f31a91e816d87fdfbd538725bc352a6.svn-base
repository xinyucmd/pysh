					...
					<div>
						<table border="0" cellspacing="0" cellpadding="0">
							<tr>
								...
								<a href="lateRepayInit.do">逾期的还款</a>
							</td>
							<td width="2">
								&nbsp;
							</td>
							<td width="100" id="today" height="28"  class="xxk_all_a">
								<a href="overduePaymentInit.do">逾期垫付</a>
							</td>
							<td width="2">
								&nbsp;
							</td>
						...
						<table cellspacing="1" cellpadding="3">
							<tr>
								<td class="blue12 left">
									用户名：${map.borrower}
									<input type="hidden" id="repayId" value="${map.repayId}"/>
								</td>
								<td class="blue12 left">
									欠款总额：${map.forSum}元
								</td>
                            ...
                            <tr>
								<td colspan="2" class="blue12 left">
									借款标题：
									<a href="${frontUrl}financeDetail.do?id=${map.borrowId}" target="_blank">${map.borrowTitle}</a>
								</td>
							</tr>
							<tr>
								<td colspan="2" class="blue12 left">
			...
			<tbody>
				...
				<tr align="center" class="gvItem">
				    ...
				    <td>${map.totalSum}</td>
							...
							<div id="content">
							<table>
							<tr><td colspan="2" class="blue12 left">催收记录</td></tr>
							<tr>
							    <td colspan="2" class="blue12 left">
									催收结果：
									<br/><textarea style="margin-left:80px;" id="colResult" cols="30" rows="10"></textarea>
								</td>
							</tr>
							<tr>
							    <td colspan="2" class="blue12 left">
									署名备注：<span style="margin-left:15px;"><input id="remark" type="text"/></span>
								</td>
							</tr>
							<tr>
			...
			<tbody>
				...
				<s:iterator value="#request.collectionList" var="collection">
					<tr class="gvItem">
						...
						<td>
							<a href="javascript:delCollection(${collection.id});">删除</a>
						</td>
					</tr>
				</s:iterator>
				</s:else>
