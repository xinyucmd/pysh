	...
	<body>
						...
						<table width="60%" border="0" cellspacing="1" cellpadding="3" align="center">
							...
							<tr>
								<td style="width: 150px; height: 30px;"
									class="blue12">
									<span style="font-weight: bold">安卓当前版本号: </span>
								</td>
							...
							<tr>
								<td style="width: 150px; height: 30px;"
									class="blue12">
									<span style="font-weight: bold">IOS当前版本号: </span>
								</td>
								<td align="left" class="f66">
									<s:textfield id="curNumIos" name="paramMap.curNumIos"
										 theme="simple" value="%{#request.appMap.curNumIos}"></s:textfield>
									<span class="require-field" id="e_host"></span>
								</td>
							</tr>
							...
							<tr>
								<td style="width: 150px; height: 30px;"
									class="blue12">
									<span style="font-weight: bold">是否强制更新（0否，1是）: </span>
								</td>
								<td align="left" class="f66">
									<s:textfield id="appForce" name="paramMap.appForce"
										 theme="simple" value="%{#request.appMap.appForce}"></s:textfield>
									<span class="require-field" id="e_host"></span>
								</td>
							</tr>
							...
							<tr>
								<td style="width: 150px; height: 30px;"
									class="blue12">
									<span style="font-weight: bold">是否显示IOS更新层（0否，1是）: </span>
								</td>
								<td align="left" class="f66">
									<s:textfield id="app_state" name="paramMap.app_state"
										 theme="simple" value="%{#request.appMap.app_state}"></s:textfield>
									<span class="require-field" id="e_host"></span>
								</td>
							</tr>
		...
		$(function(){
	  	 ...
	  	 $('#btn_tijiao').click(function(){
			  	 if($("#curNum").val()==""){
			  		$("#e_host").html("安卓当前版本号不能为空!");
					return false;
			  	}else{
			  		$("#e_host").html("*");
				 }
			  	if($("#curNumIos").val()==""){
			  		$("#e_host").html("IOS当前版本号不能为空!");
					return false;
			  	}else{
			  		$("#e_host").html("*");
				 }
		  ...
		  param["paramMap.curNumIos"] = $("#curNumIos").val();
		  param["paramMap.appForce"] = $("#appForce").val();
		  param["paramMap.content"] = $("#content").val();
		  param["paramMap.app_state"] = $("#app_state").val();
