...
public class IConstants {
	 ...
	 * 体验金变量
	 */
	public static  Integer TJY = 0;  //导出记录_最大值
	/**
	 * 排序方式：倒序
	 */
	 ...
	 * 网站app版本
	 */
	public static String WEB_APP_VERSION  = "";
	...
	public static final String PLATFORM_REGIST="noRegist";
	//--------------------------注册常量--------------------------//
	/**
	 * 注册成功
	 */
	...
	public static String NICK = "";//邮件发送人昵称
	public static  String MAIL_HOST="";
	public static  String MAIL_USERNAME="";
	public static  String MAIL_PASSWORD="";
	public static  String MAIL_FROM="";
	public static String ISDEMO="";
	public static String PUBLISH_BORROW_ADMIN_ID="";
	public static String PUBLISH_BORROW_ADMIN_NAME="";
	
	public static String REDIS_IPADDR="";
	...
	public static String sesPWd ="";
	public static String sesKey ="";
	public static String LICENSE ="";
	public static String APP_URL = "";
	public static String CSAI_UPDATE = "";
	public static String CSAI_CREATE = "";
	...
	static{
		try {
			...
			WEB_APP_VERSION = pf.read("web_app_version");
			WEB_APP_URL = pf.read("web_app_url");
			...
			APP_URL = pf.read("app_url");
			ENABLED_PASS =pf.read("enabled_pass");
			PASS_KEY = pf.read("pass_key");
			PUBLIC_KEY = pf.read("public_key");
			PRIVATE_KEY = pf.read("private_key");
			PRO_GLOBLE_NAME = pf.read("pro_globle_name");
			NICK = pf.read("pro_globle_name");
			OPERATOR_ONLINE = pf.read("pro_globle_name");
			sesPWd=pf.read("com.shove.security.sesPWd");
			sesKey = pf.read("app_see_key");
			LICENSE = pf.read("com.shove.security.License");
			
			PUBLISH_BORROW_ADMIN_ID = pf.read("publish_borrow_admin_ID");
			PUBLISH_BORROW_ADMIN_NAME = pf.read("publish_borrow_admin_name");
			CSAI_UPDATE = pf.read("csai_update");
			CSAI_CREATE = pf.read("csai_create");
			SUPER_ID = pf.read("super_id");
			
			REDIS_IPADDR = pf.read("redis_ipAddr");
			REDIS_PORT = pf.read("redis_port");
			REDIS_TIMEOUT = pf.read("redis_timeout");
			CHECK_ID = pf.read("check_id");
...
//			RENREN_OAUTH_URL = pf.read("renren_oauth_url");
    ...
    public static final String BORROW_TYPE_NET_VALUE_STR = "净值借款";
    
    public static final String BORROW_TYPE_SECONDS_STR = "秒还借款";
    
    public static final String BORROW_TYPE_GENERAL_STR = "信用借款";
...
//	public static final int BANK_CHANGE = 4;
	...
	public static  String OPERATOR_ONLINE = "";
	...
	public static final int WITHDRAW_MAX = 1000000;//设置最大提现金额，超过之后要收取手续费
	...
	public static final float I_MANAGE = 0.1f;
	
	public final static String DLLCALLCERT = "com.shove.security.License.Cert";
	
	public final static String SERIALNUMBER = "com.shove.security.License.SerialNumber";
	
	//邮件端口
	public static Integer MAIL_PORT = 0;
	
	public static String AFTER_LOGIN_URL ="afterLoginUrl";
	public static String AFTER_LOGIN_AJAX_URL = "afterLoginAjaxUrl";
	
	// 用于用户提示
	public static String UPDATE_SUCCESS_STATUS = "1";
	public static String UPDATE_SUCCESS_STATUS_LABLE = "更新成功！";
	public static String UPDATE_FAILE_STATUS = "0";
	public static String UPDATE_FAILE_STATUS_LABLE = "更新失败！";
	
	public static int ACTIVITY_RECOMMEND_REG_MAX = 100;// 最大推荐人数
	public static String ACTIVITY_RECONMMEND = "1001";
	public static String PERSON_RECONMMEND = "recommend";
	public static double ACTIVITY_RECOMMEND_REG_AMOUNT = 50;
	public static int RECOMMEND_BROKERAGE_TYPE_REG = 1;
	public static int RECOMMEND_BROKERAGE_TYPE_INVEST = 2;
	
	public static String RECOMMEND_PROCESS_1 = "1";// 活动的第一阶段
	public static String RECOMMEND_PROCESS_2 = "2";// 活动的第二阶段
	
	public static String ACTIVITY_END_YEAR = "1002";
	
	public static String DEBT_INVEST_PWD = "1jcbanking768";
