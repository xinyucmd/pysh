												...
												<ul>
													...
													<s:else>
														<s:iterator value="#request.basepictur" var="bean" status="sta">
													     ...
													     <li <s:if test="#sta.count%3==0"> style="margin-right:0px;"</s:if>>        
													        <div class="pic"><img src="../images/baseimage_${sta.count}.jpg" width="62" height="62" id="img_identiy" /></div>
													         <div class="shangchuan">
													         	<h3 style=" padding-left:0;">${tmyname }</h3>	
													         <!-- 
						     						...
						     						<li style="margin: 0;padding:0px; width: 100%;border:0px; height: 25px;">其他资料上传</li>
														<s:iterator value="#request.otherpictur" var="bean" status="sta">
						     
													     <li   
													     <s:if test="#sta.count%3==0"> style="margin-right:0px;"</s:if>
													     >        
													        <div class="pic">
													         <img src="../images/baseimage_${sta.count}.jpg" width="62" height="62" id="img_identiy" /></div>
													         <div class="shangchuan">
													         <h3 style=" padding-left:0;">${tmyname }</h3>	
													         <!-- 
													         <input type="button" id="bu_identiy" class="scbtn" style="cursor: pointer;" value="点击上传" onclick="fff()"/>
...
$("#fancybox").fancybox({
  ...
  <script>
   ...
   function fff(data){
                ...
                var userId = '${userId}';
                var type = '${type}';
		    	  $.jBox("iframe:queryUserPicturAdmin.do?paramMap.userId="+userId+"&dm="+t+"&paramMap.type="+type, {
	   		    		title: "上传",
	   		    		width: 520,
	   		    		height: 430,
	   		    		buttons: {  }
...
<script>
  //视频上传验证
   function shipingcheck(data){
                var t = $(data).attr("sd");
		    	jQuery.jBox.open("showshiping.do?dm="+t, "上传", 460,400,{ buttons: { } });
		    }
