					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
						<tr>
							<td width="100" id="today" height="28"  class="main_alll_h2">
								<a href="queryRewardActivityInit.do">投资人奖励</a>
							</td>
                             <td width="2">
						...
						<tbody>
							<tr>
								<td class="f66" align="left" width="50%" height="36px">
									...
									已发奖励总额:
									<input id="issuedAmountDown" value=""  class="inp80" />&nbsp;&nbsp;
									--
									<input id="issuedAmountUp" value=""  class="inp80" />&nbsp;&nbsp;
									用户类型:
...
<script type="text/javascript">
			...
			function initListInfo(praData){
				...
				praData["paramMap.issuedAmountDown"] = $("#issuedAmountDown").val();
				praData["paramMap.issuedAmountUp"] = $("#issuedAmountUp").val();
				praData["paramMap.type"] = $("#type").val();
		 		$.shovePost("queryRecommendList.do",praData,initCallBack);
		 	}
