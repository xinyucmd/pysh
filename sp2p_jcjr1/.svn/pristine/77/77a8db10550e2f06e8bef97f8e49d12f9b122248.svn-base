...
public class PublicModelService extends BaseService {
	 ...
	 * @throws SQLException
	 */
	public void queryBannerListPage(PageBean<Map<String, Object>> pageBean, int flag)
			throws Exception {
		Connection conn = MySQL.getConnection();
		try {
			dataPage(conn, pageBean, " t_links ", "*",
					"  order by ordershort asc ", " and type = 3 and ImgType = "+flag);
		} catch (Exception e) {
			log.error(e);
			e.printStackTrace();
			throw e;
	 ...
	 * @throws DataException
	 */
	public void deleteIndexRollImg(String commonIds) throws Exception,
			DataException {
		Connection conn = MySQL.getConnection();
		try {
			linksDao.deleteIndexRollImg(conn, commonIds);
			conn.commit();
		} catch (Exception e) {
			log.error(e);
			e.printStackTrace();
	 ...
	 * @throws DataException
	 */
	public Map<String, String> queryLinksInfoByids(long id) throws Exception {
		Connection conn = MySQL.getConnection();
		Map<String, String> map = null;
		try {
			map = linksDao.queyLinksInfoByIds(conn, id);
		} catch (Exception e) {
			log.error(e);
			e.printStackTrace();
	...
	public Long addIndexRollImg(String companyImg, long serialCount,
			String dateTime, long ordershort, int cardStatus,String companyURL, int ImgType)
			throws Exception {
		Connection conn = MySQL.getConnection();
		Long commonId = -1L;
		Long newsId = -1L;
	...
	public Long updateIndexRollImg(String companyImg, long serialCount,
			String dateTime, long ordershort,String companyURL,int ImgType) throws Exception {
		Connection conn = MySQL.getConnection();
		try {
			linksDao.updateIndexRollImg(conn, companyImg, serialCount,
					ordershort, dateTime,companyURL,ImgType);
			conn.commit();
		} catch (Exception e) {
			log.error(e);
			e.printStackTrace();
