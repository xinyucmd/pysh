					...
					<div class="tab">
						<table cellspacing="1" cellpadding="3">
							...
							<s:else>
									...
									<td class="f66 leftp200">
	                                                                                                最高投标金额：
	                                    <s:if test="%{borrowMFlowMarkDetail.maxTenderedSum=='-1.00'}">
								                           没有限制
								        </s:if>
								        <s:else>
							...
							<tr>
								<td colspan="2" class="blue12 left">
									借款人认证审核查看：<a href="queryPerUserCreditAction.do?userId=${borrowMFlowMarkDetail.new_userId}&userId_admin=${borrowMFlowMarkDetail.new_userId_admin}&publisWay=${borrowMFlowMarkDetail.publisherWay}" target="_blank">申请人认证详情查看</a>
								</td>
							</tr>
							</table>
							<div id="content">
