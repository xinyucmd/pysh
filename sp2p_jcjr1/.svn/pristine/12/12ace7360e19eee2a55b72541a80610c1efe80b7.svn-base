												...
												<tr>
													<td class="xxk_all_a" height="20" align="center"
														...
														<a style="cursor: pointer;"
															onclick="javascript:window.location.href='queryUserManageBaseInfoinner.do?i=${userId}';">个人基本信息</a>
													</td>
													<td>
														&nbsp;
													</td>
													<td class="xxk_all_a1" width="100px" height="20"
														align="center">
														<a style="cursor: pointer;" href="queryUserMangework.do?uid=${userId}">工作信息</a>
													</td>
													<td>
														&nbsp;
													</td>
													<td  class="main_alll_h2" width="100px" height="20"
														align="center">
														<a style="cursor: pointer;" onclick="javascript:window.location.href='queryUserManageInvest.do?i=${userId}';" >投资信息</a></td>
												</tr>
											</table>
										</td>
									</tr>
