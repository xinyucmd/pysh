					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
						<tr>
							<td width="100" id="today" height="28" class="main_alll_h2">
								<a href="queryborrowStatisUserGroupInit.do">用户组统计</a>
							</td>
							<td width="2">
								&nbsp;
							</td>
...
<script type="text/javascript">
			$(function(){
				...
				$("#excel").attr("disabled",true);
				   window.location.href=encodeURI(encodeURI("exportUserGroup.do?groupName="+$("#groupName").val()));
			...
			function initListInfo(praData){
				praData["paramMap.groupName"] = $("#groupName").val();
		 		...
		 		$.shovePost("queryborrowStatisUserGroupPage.do",praData,initCallBack);
		 	}
