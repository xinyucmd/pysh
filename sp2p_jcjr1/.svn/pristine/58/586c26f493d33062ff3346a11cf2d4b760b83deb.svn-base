...
public class ClauseAction extends BasePageAction {
	...
	public String addClause() throws Exception {
		String columnName = paramMap.get("columName"); // 标题
	...
	public String updateClauseInit() throws Exception {
		long id = request.getLong("commonId", -1);
		try {
	...
	public String updateClause() throws Exception {
		String columnName = Convert.strToStr(paramMap.get("columName"), null); // 标题
		String content = Convert.strToStr(paramMap.get("content"), null);// 条款内容
	...
	public String deleteClause() throws Exception {
		String clauseIds = request.getString("commonId");
