    ...
    <div class="pic-info">
      <div class="tx">
       <shove:img src="${paramMap.imgPath }" defaulImg="images/default-img.jpg" width="180" height="180" ></shove:img>
           ...
           <!-- Baidu Button BEGIN -->
<div id="bdshare" class="bdshare_t bds_tools get-codes-bdshare" style="width:220px;">
<a class="bds_qzone"></a>
<a class="bds_tsina"></a>
<a class="bds_tqq"></a>
...
<a class="shareCount" style="display:inline-block;"></a>
</div>
...
<!-- Baidu Button END -->
      ...
      <div class="xqbox" style="width:520px !important;">
      <h3>${paramMap.borrowTitle }</h3>
      <div class="xqboxmain" style="width:520px !important;">
      <div class="xqtop" style="width:520px !important;">
        <div class="money">
        <p>债权总额：<strong>￥${paramMap.debtSum }元</strong></p>
        <s:hidden id="debtId" name="paramMap.debtId"></s:hidden>
		<%-- //whb去掉竞拍<p>竞拍底价：<strong style="font-size:12px;">￥${paramMap.auctionBasePrice }元</strong></p> --%>
        </div>
        <div class="tbbtn">
 ...
 <%--  </td>
  ...
  <tr>
    <td colspan="">竞拍数：<s:if test="paramMap.auctionCount==\"\"">0</s:if><s:else>${paramMap.auctionCount}</s:else>   浏览量：${paramMap.viewCount }</td> --%>
  ...
  <tr>
    <td colspan="3">发布时间：${paramMap.publishTime }
      ...
      <div class="reninfo" style="margin-right:15px;">
        <div class="rinfomain">
        <div class="tx">
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td align="right" width="70px">用&nbsp;户&nbsp;名： 
    </td>
    <td>${userMap.username}  </td>
  </tr>
  <tr>
    <td  align="right" >居&nbsp;住&nbsp;地：
    </td>
    <td class="user_addressed">${userMap.address} </td>
  </tr>
  <tr>
    <td  align="right">信用指数：</td>
    <td> <img src="images/ico_${userMap.creditratingIco}.jpg" title="${userMap.creditrating}分" width="33" height="22" /></td>
  </tr>
  <tr>
