...
input{ border:none;}
	...
	.theme-popover ul li{ line-height:32px;}
	.theme-popover ul li label{}
	.btn-big{ width:160px; height:32px; border:solid 1px #CCC; color:#000; padding-left:10px;}
...
<div style="padding: 15px 10px 0px 10px;">
	<div>
    	<div class="menu">
            <ul>
                <li class="main_alll_h2"><a href="borrowBackstages.do">个人后台代发标</a>  </li>
                <li class="xxk_all_a"><a class="theme-login">添加体验标</a></li>
            </ul>
        </div>
...
<div class="theme-popover" >
        <div>
       	  <ul>
                ...
                <li>
                	<label>借款金额</label>
                    <input name="" type="text" value="8888" disabled="disabled" class="btn-big" />
                </li>
                 <li>
                	<label>借款倍数</label>
            ...
            <p style="text-align:center;"><button onclick="addBorrowNews()" type="button" value="确定提交"  style="width:80px; height:30px; background:#1367b6; color:#fff; border:none; line-height:30px; text-align:center;">确认提交</button></p>
        </div>	
		    ...
		    success: function (data) {
		    	...
		    	if(data.result != null && data.result != undefined && data.result != ''){
		    		...
		    		for(var i=0;i<data.result.length;i++){
	                    ...
	                    strHtml +="<td align='center' >"+o.name+"</td>";
	                    strHtml +="<td align='center' style='width:19%;'>"+o.rate+"%</td>";
	                    strHtml +="<td align='center' >"+o.day+"天</td>";
	                    strHtml +="<td align='center'>"+o.amount_sum+"元</td>";
