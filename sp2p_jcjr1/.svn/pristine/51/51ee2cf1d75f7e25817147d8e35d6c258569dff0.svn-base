	...
	<head>
		...
		<script type="text/javascript">
			...
			function initListInfo(praData){							    
		 		$.shovePost("queryMediaReportListPage.do",praData,initCallBack);
		 	}
			...
			function dels(){
	 			...
	 			window.location.href= "deleteMediaReport.do?id="+ids;
		 	}
		 	...
		 	function del(id){
	 			...
	 			window.location.href= "deleteMediaReport.do?id="+id;
		 	}
		 	
		 	//媒体报道预览  houli
		 	function preview(id){
		 	  var url = "preViewMediaReportInit.do?id="+id;
					...
					<table border="0" cellspacing="0" cellpadding="0">
						<tr>
							<td width="100" height="28"  class="xxk_all_a">
								<a href="queryNewsListInit.do">官方公告管理</a>
							</td>
							<td width="2">
								&nbsp;
							</td>
							<td width="100"  class="xxk_all_a">
								<a href="addNewsInit.do">添加官方公告</a>
							</td>
							<td width="2">
								&nbsp;
							</td>
							...
							<td width="100"  class="xxk_all_a">
								<a href="addInfomationInit.do">添加行业资讯</a>
							</td>
							<td width="2">
								&nbsp;
							</td>
							...
							<td width="100" height="28"  class="xxk_all_a">
								<a href="queryLicaiListInit.do">理财知识管理</a>
							</td>
							<td width="2">
								&nbsp;
							</td>
							<td width="100"  class="xxk_all_a">
								<a href="addLicaiInit.do">添加理财知识</a>
							</td>
							<td width="2">
								&nbsp;
							</td>
