	...
	<div>
		<table id="gvNews" style="width: 100%; color: #333333;"
			...
			<tbody>
				...
				<tr>
				<td  colspan="3"><strong>合计项</strong> &nbsp;&nbsp;提成奖励总计:￥<s:if test="%{paramMap.moneySum==''}">0.00</s:if><s:else>
				...
				<td  align="center" ><fmt:formatNumber value="${countMoney}" type="currency" pattern="￥0.00"/></td>		
				</tr>
			</tbody>
		</table>
	</div>
