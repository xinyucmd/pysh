		...
		<script type="text/javascript">
			$(function(){
				...
				param["pageBean.pageNum"] = 1;
				 ...
				 param["paramMap.createTimeMin"] = $("#createTimeMin").val();
				 param["paramMap.createTimeMax"] = $("#createTimeMax").val();
			     initListInfo(param);
				});
						...
						<table style="margin-bottom: 8px;" cellspacing="0" cellpadding="0"
							...
							<tbody>
								...
								<td class="f66" align="left" width="80%" height="36px">
										...
										开始时间
										<input id="createTimeMin"  type="text"  name ="paramMap.createTimeMin" 
					                           onClick="WdatePicker({dateFmt:'yyyy-MM-dd',readOnly:'readOnly'})"/>
					                                                      结束时间
										<input id="createTimeMax"  type="text"  name ="paramMap.createTimeMax" 
					                           onClick="WdatePicker({dateFmt:'yyyy-MM-dd',readOnly:'readOnly'})"/>
