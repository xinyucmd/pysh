						...
						<table cellspacing="1" cellpadding="3">
							...
							--%><tr>
	                            <td class="blue12 left">
								  ...
								  审核状态 :<input type="radio" name="paramMap_valid" value="5" onclick="javascript:$('#u_tip').html('')" 
<s:if test='#request.map.tpistatus == 5'>checked="checked"</s:if> 
<s:else></s:else> 
/>成功 <input type="radio" name="paramMap_valid" value="6" 
<s:if test='#request.map.tpistatus == 6'>checked="checked"</s:if> 
<s:else></s:else> 
/>失败 
