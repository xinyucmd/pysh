  ...
  <div class="sqdk" style="background:none;height:auto;padding: 0px;">
    ...
    <div class="tcbox" style="display:-none; position:static; margin:0px auto; padding:0px;">
      ...
      <s:if test="#request.typmap.materAuthTypeId==6">
            <h3>房产认证：</h3>
      <p>房产证明是证明借入者资产及还款能力的重要凭证,${sitemap.siteName}会根据借款者提供的房产证明给与借入者一定的信用加分。</p>
...
<br />
      ...
      <s:if test="#request.typmap.materAuthTypeId==2">
            <h3>工作认证：</h3>
      <p>您的工作状况是${sitemap.siteName}评估您信用状况的主要依据。请您填写真实可靠的工作信息。 </p>
      <p><strong>认证说明：</strong><br />
...
3、 请确认您上传的资料是清晰的、未经修改的照片，每张照片最大限制为1M
      ...
      <s:if test="#request.typmap.materAuthTypeId==3">
            <h3>居住地认证：</h3>
      <p>居住地的稳定性，是${sitemap.siteName}考核借款人的主要评估因素之一，通过${sitemap.siteName}居住地证明，您将获得一定的信用加分。 </p>
      <p><strong>认证说明：</strong><br />
...
2、 请确认您上传的资料是清晰的、未经修改的照片，每张照片最大限制为1M
      ...
      <s:if test="#request.typmap.materAuthTypeId==4">
            <h3>央行信用认证：</h3>
      <p>个人信用报告是由中国人民银行出具，全面记录个人信用活动，反映个人信用基本状况的文件。本报告是${sitemap.siteName}了解您信用状况的一个重要参考资料。 您信用报告内体现的信用记录，和信用卡额度等数据，将在您发布借款时经${sitemap.siteName}工作人员整理，在充分保护您隐私的前提下披露给${sitemap.siteName}借出者，作为借出者投标的依据。</p>
      <p><strong>认证说明：</strong><br />
...
3、 请确认您上传的资料是清晰的、未经修改的照片，每张照片最大限制为1M
      ...
      <s:if test="#request.typmap.materAuthTypeId==5">
            <h3>收入认证：</h3>
      <p>您的银行流水单以及完税证明，是证明您收入情况的主要文件，也是${sitemap.siteName}评估您还款能力的主要依据之一。 </p>
      <p><strong>认证说明：</strong><br />
      1、工薪阶层（入职须6个月以上）：<br />
请上传以下一项或者多项资料的照片<br />
...
3、 请确认您上传的资料是清晰的、未经修改的照片，每张照片最大限制为1M
      ...
      <s:if test="#request.typmap.materAuthTypeId==7">
            <h3>车辆认证：</h3>
      <p>购车证明是证明借入者资产及还款能力的重要凭证之一，${sitemap.siteName}会根据借入者提供的购车证明给与借入者一定的信用加分。</p>
      <p><strong>认证说明：</strong><br />
...
3、 请确认您上传的资料是清晰的、未经修改的照片，每张照片最大限制为1M<br />
      ...
      <s:if test="#request.typmap.materAuthTypeId==8">
            <h3>结婚认证：</h3>
      <p>借入者的婚姻状况的稳定性，是${sitemap.siteName}考核借款人信用的评估因素之一，通过${sitemap.siteName}结婚认证，您将获得一定的信用加分。</p>
      <p><strong>认证说明：</strong><br />
 1、	请您上传以下资料<br />
...
2、 请确认您上传的资料是清晰的、未经修改的照片，每张照片最大限制为1M
      ...
      <s:if test="#request.typmap.materAuthTypeId==10">
            <h3>技术职称认证：</h3>
      <p>技术职称是经专家评审、反映一个人专业技术水平并作为聘任专业技术职务依据的一种资格，不与工资挂钩，是${sitemap.siteName}考核借款人信用的评估因素之一，通过${sitemap.siteName}技术职称认证证明，您将获得一定的信用加分。</p>
      <p><strong>认证说明：</strong><br />
...
2、 请确认您上传的资料是清晰的、未经修改的照片，每张照片最大限制为1M
      ...
      <s:if test="#request.typmap.materAuthTypeId==11">
            <h3>手机认证：</h3>
      <p>手机流水单是最近一段时间内的详细通话记录，是${sitemap.siteName}用以验证借入者真实性的重要凭证之一。您的手机详单不会以任何形式被泄露。</p>
      <p><strong>认证说明：</strong><br />
...
1、 请确认您上传的资料是清晰的、未经修改的照片，每张照片最大限制为1M
      ...
      <s:if test="#request.typmap.materAuthTypeId==13">
            <h3>现场认证：</h3><br/>
           <p> 请上传盖有${sitemap.siteName}公章的现场认证书</p>
      <p><strong>认证说明：</strong><br />
...
<s:if test="#request.typmap.materAuthTypeId==16">
 ...
 <s:if test="#request.typmap.materAuthTypeId==17">
            <h3>法人身份认证：</h3>
      <p>您上传的身份证扫描件需和您绑定的身份证一致，否则将无法通过认证。</p>
      <p><strong>认证说明：</strong><br />
1.请您上传本人身份证原件的正、反两面的第二代身份证照片。 <br>
...
<s:if test="#request.typmap.materAuthTypeId==18">
            <h3>营业执照正副本：</h3>
      <p>您上传的身份证扫描件需和您绑定的身份证一致，否则将无法通过认证。</p>
      <p><strong>认证说明：</strong><br />
1.请您上传本人身份证原件的正、反两面的第二代身份证照片。 <br>
...
<s:if test="#request.typmap.materAuthTypeId==19">
            <h3>组织机构代码证：</h3>
      <p>您上传的身份证扫描件需和您绑定的身份证一致，否则将无法通过认证。</p>
      <p><strong>认证说明：</strong><br />
1.请您上传本人身份证原件的正、反两面的第二代身份证照片。 <br>
...
<s:if test="#request.typmap.materAuthTypeId==20">
            <h3>税务登记证：</h3>
      <p>您上传的身份证扫描件需和您绑定的身份证一致，否则将无法通过认证。</p>
      <p><strong>认证说明：</strong><br />
1.请您上传本人身份证原件的正、反两面的第二代身份证照片。 <br>
...
<s:if test="#request.typmap.materAuthTypeId==21">
            <h3>企业银行账号：</h3>
      <p>您上传的身份证扫描件需和您绑定的身份证一致，否则将无法通过认证。</p>
      <p><strong>认证说明：</strong><br />
1.请您上传本人身份证原件的正、反两面的第二代身份证照片。 <br>
...
<tr>
  ...
  <p></p>
   ...
   <tr style="width: 100%">
    ...
    <td  style="color: red;font-size: 12px" >${sitemap.siteName}是一个注重诚信的网络平台。如果我们发现您上传的资料系伪造或有人工修改痕迹，${sitemap.siteName}会将你加入系统黑名单，永久取消您在${sitemap.siteName}的借款资格。</td>
  </tr>
   ...
   //获取本来在数据库的图片获取他们的id
    ...
    $("input[name=items]").each(function() { 
     ...
     parama["paramMap.listlen"] = '${len}';
      ...
      parama["paramMap.type"] = '${type}';
      
      
     $.post("addpastPicturdateAdmin.do",parama,function(data){
      if(data==123){
      alert('申请认证成功');
