...
<div class="lne_cent">
            	...
            	<div style="background:#fff;padding-bottom:5px; margin-bottom:10px;">
                     <div class="myhome_tit tab_meun">
                        <ul>
                            ...
                            <li class="on" style="border-right:none; width:154px; *width:152px;" onclick="jumpUrl('queryPayoffList.do');">已还完的借款</li>
                        </ul>
                    </div>
 
        <div class="mg-height">
        <form action="queryPayoffList.do" id="searchForm" method="post" class="form-inline">
      ...
      <div class="form-group" style="width:150px\9;">
        ...
        <input type="button"  value="导出excel表" onclick="excel3()" class="btn btn-primary" style=" position:relative; right:0;"/>
...
$(function(){
   ...
   function excel3()
     {
    window.location.href=encodeURI(encodeURI("exportSuccessBorrow.do?status=5"+"&&startTime="+$("#startTime").val()+"&&endTime="+$("#endTime").val()+"&&title="+$("#title").val()));
