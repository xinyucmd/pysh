			...
			<tbody>
				...
				<s:iterator value="pageBean.page" var="bean" status="s">
					<tr class="gvItem">
						...
						<td>
						   <s:if test="#bean.publisherWay==2">
							<span class="require-field">${authCount}</span>个
							</s:if>
						   <s:elseif test="#bean.counts==null">
					...
					<td>
						 ...
						 <a href="javascript:dataToCsai(${id});">推送</a>
					</td>
					</tr>
				</s:iterator>
				</s:else>
				...
				<td colspan="4" align="right" >当前页的招标借款金额合计:</td>
				<td  align="center" >￥${tenderAmount}</td>	
				<td colspan="3" align="right" >招标借款金额合计:</td>
				<td  colspan="2" >￥
				<s:if test="%{#request.repaymentMap.tenderBorrowAmount==''}">0</s:if>
				<s:else> <s:property value="#request.repaymentMap.tenderBorrowAmount" default="0"/></s:else>	
				</td>		
				</tr>
			</tbody>
		</table>
