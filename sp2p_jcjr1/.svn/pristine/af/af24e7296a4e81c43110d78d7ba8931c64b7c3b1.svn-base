		...
		<script type="text/javascript">
			...
			function initListInfo(param){	
			     param["paramMap.sender"] = $("#sender").val();	
  	             ...
  	             param["paramMap.mailType"] = 2;
		 		$.shovePost("queryMailBoxListPage.do",param,initCallBack);
		 	}
			...
			function dels(){
	 			...
	 			window.location.href= "delewmail.do?id="+ids;
		 	}
		 	...
		 	function del(id){
	 			...
	 			window.location.href= "delewmail.do?id="+id;
		 	}
					...
					<table border="0" cellspacing="0" cellpadding="0">
						<tr>
							...
							<td id="adusers" width="100"  class="xxk_all_a">
								<a href="queryMailBoxListUserInit.do?mailType=1">用户与用户</a>
							</td>
							<td width="2">
								&nbsp;
							</td>
