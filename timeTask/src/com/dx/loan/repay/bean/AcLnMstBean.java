...
public class AcLnMstBean {
	...
	private String serFeeReturnId;
	private String collectfeeId;
	private String settleModel;//结算模式
	...
	public String getSerFeeReturnId() {
		return serFeeReturnId;
	}

	public void setSerFeeReturnId(String serFeeReturnId) {
		this.serFeeReturnId = serFeeReturnId;
	}
