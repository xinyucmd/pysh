...
$(document).ready(function(){
	...
	cellWidth = (maiwidth-118)/7;
	cellWidth=parseInt(cellWidth);
	var h = maiheight - gapTop - otherpm;
	var grid=$("#flexTable").flexigrid({
		width: w,
		height: h,
		url: 'putout_additiList.action',
		dataType: 'json',
		colModel : [
		//{display: '编号', name : 'id', width : 50, sortable : true, align: 'center',hide: true,toggle : false,process:formatMoney},
			{display: '合同号', name : 'due_no', width : cellWidth, sortable : true, align: 'center'},
			{display: '客户号', name : 'cif_no', width : cellWidth, sortable : true, align: 'center'},
			{display: '证件号码', name : 'card_no', width : cellWidth, sortable : true, align: 'center'},
			{display: '合同金额', name : 'pact_amt', width : cellWidth, sortable : true, align: 'center'},
			{display: '业务种类', name : 'loan_kind', width : cellWidth, sortable : true, align: 'center'},																
			{display: '当前状态', name : 'pact_sts', width : cellWidth, sortable : true, align: 'center'},																
			{display: '操作', name : 'op', width : cellWidth, link: true, align: 'center'}														
		...
		searchitems : [
			{display: '合同号', name : 'pact_no'},
			{display: '客户号', name : 'cif_no'},
			{display: '证件号码', name : 'card_no'},
			{display: '合同金额', name : 'pact_amt'},
			{display: '业务种类', name : 'loan_kind'},																
			{display: '当前状态', name : 'pact_sts'}																
			],
		errormsg: '发生异常',
		sortname: "pact_no",
		sortorder: "desc",
...
var	mydata =  parm.split('#');
	...
	window.location.href="putout_toPactAddit.action?pactNo=123456";
}
