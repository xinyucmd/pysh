$(document).ready(function(){
	...
	var grid=$("#flexTable").flexigrid({
		width: w,
		height: h,
		url: 'pzZiList_pzZiList.action',
		dataType: 'json',
		colModel : [

			{display: '凭证打印标题', name : 'ptitle', width : cellWidth, sortable : true, align: 'center'},
			{display: '编码前缀', name : 'pz_qz', width : cellWidth, sortable : true, align: 'center'},
			{display: '编码方式', name : 'code_type', width : cellWidth, sortable : true, align: 'center'},
			{display: '起始流水号', name : 'trace_No', width : cellWidth, sortable : true, align: 'center'},
			{display: '是否默认', name : 'is_auto', width : cellWidth, sortable : true, align: 'center'},																
		...
		searchitems : [
			{display: '凭证打印标题', name : 'ptitle'},
			{display: '编码前缀', name : 'pz_qz'},
			{display: '编码方式', name : 'code_type'},
			{display: '起始流水号', name : 'trace_No'},
			{display: '是否默认', name : 'is_auto'}																
			],
		errormsg: '发生异常',
		sortname: "ptitle",
		sortorder: "desc",
