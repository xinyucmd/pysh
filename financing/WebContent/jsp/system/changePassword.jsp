...
function submitForm(){
	...
	$.ajax({
	    type: "POST",
	    url: "checkPasswordChange.action",
	    data: params,
	    dataType:"text", 
    ...
    <div id="feature">
      ...
      <div id="shortcuts" class="headerList">
        <span> <span style="white-space: nowrap;"> <a
            ...
            iconCls="icon-update" onclick="submitForm();"
        ...
        <s:form id="changePasswordForm" validate="true"
          ...
          <table style="padding: 10px;" cellspacing="10" cellpadding="0"
            ...
            <tr>
              ...
              <td class="td-value"><input name="oldPassword" id="oldPassword"
            ...
            <tr>
              ...
              <td class="td-value"><input name="newPassword" id="newPassword"
                class="easyui-validatebox record-value"
            ...
            <tr>
              ...
              <td class="td-value"><input name="confirmPassword" id="confirmPassword"
                class="easyui-validatebox record-value"
