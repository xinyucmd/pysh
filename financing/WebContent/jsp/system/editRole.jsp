          ...
          <div class="easyui-tabs">
            <div title="<s:text name='tab.overview'/>"
              ...
              <table class="view-table" cellspacing="0" cellpadding="0"
                ...
                <tr>
                  <td class="view-column"><s:text
                      name="entity.agreement.label" /></td>
                ...
                <tr>
                  <td class="view-column"><s:text
                      name="entity.financing.label" /></td>
                  <td class="view-column"><s:select
                ...
                <tr>
                  ...
                  <td class="view-column"><s:select id="scope_lead"
                      name="role.scope_lead" list="scopeMap"
                      style="width:100px;" /></td>
                  <td class="view-column"><s:select id="view_lead"
                      name="role.view_lead" list="accessMap"
                      style="width:100px;" /></td>
                  <td class="view-column"><s:select
                      id="create_lead" name="role.create_lead"
                      list="accessMap" style="width:100px;" /></td>
                  <td class="view-column"><s:select
                      id="update_lead" name="role.update_lead"
                      list="accessMap" style="width:100px;" /></td>
                  <td class="view-column"><s:select
                      id="delete_lead" name="role.delete_lead"
                      list="accessMap" style="width:100px;" /></td>
                </tr>
                <tr>
                  <td class="view-column"><s:text
