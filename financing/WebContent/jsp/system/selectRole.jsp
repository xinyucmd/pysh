...
<script type="text/javascript">
    $(document).ready(function(){	 
  	  $("#select").click(function() {	
		  many_selectrow('selectRole.action?relationKey=<s:property value="relationKey"/>&relationValue=<s:property value="relationValue"/>&seleteIDs=');
	  });	
  ...
  <div id="page-wrap">
    <div id="feature">
      ...
      <div id="feature-content">
        ...
        <s:form id="addObjectForm" namespace="/jsp/system" method="post">
