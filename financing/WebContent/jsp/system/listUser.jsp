...
<%@ page import="com.jiangchuanbanking.util.CommonUtil"%>
...
<script type="text/javascript">
    $(document).ready(function(){
  	  $("#delete").click(function() {	
		  many_deleterow("/system/deleteUser.action?seleteIDs=");
	  });
	  ...
	  var mygrid = jQuery("#grid").jqGrid({
			datatype: "json", 
			url:'listUserFull.action', 
			mtype: 'POST',
			height: "auto",
		   	colNames:['<s:text name="entity.id.label" />','<s:text name="entity.name.label" />',
		  		   	'<s:text name="entity.role.label" />','<s:text name="entity.department.label" />',
		   	...
		   	colModel:[
		   		...
		   		{name:'role',index:'role', width:150, resizable:true, formatter:urlFmatter,stype:'select', 
			   		editoptions:{value:":全部;R01:系统管理员;R02:客户经理岗;R03:债权匹配岗;R04:财务出纳岗;R05:财务经理岗;R06:公司管理岗;R07:业务管理员"}},
		   		{name:'department',index:'department', width:150, resizable:true, formatter:urlFmatter},
      ...
      <div id="shortcuts" class="headerList">
        <b style="white-space: nowrap; color: #444;"><s:text
            ...
            <span style="white-space: nowrap;"> <a
              href="editUser.action" class="easyui-linkbutton"
            ...
            <div id="mtm1" style="width: 150px;">
              <s:if
                ...
                <div data-options="iconCls:'icon-import'"
                  onClick="openwindow('/crm/upload.jsp?entityName=User&namespace=system&title=' + '<s:text name="title.import.user" />')">
