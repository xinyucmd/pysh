    ...
    $(document).ready(function(){
	  ...
	  var mygrid = jQuery("#grid").jqGrid({
			...
			height: "auto",
		   	...
		   	rowList:[15,50,100], 
		   	multiselect: true, 
		   	caption: "<s:text name='title.grid.roles'/>"
		});
      ...
      <div id="shortcuts" class="headerList">
        <b style="white-space: nowrap; color: #444;"><s:text
            ...
            <span style="white-space: nowrap;"> <a
              href="editRole.action" class="easyui-linkbutton"
              iconCls="icon-add" plain="true"><s:text
                  name="action.createRole" /></a>
            </span>
            ...
            <span style="white-space: nowrap;"> <a id="delete"
              ...
              plain="true"><s:text name="action.deleteRole" /></a>
            </span>
            ...
            <div id="mtm1" style="width: 150px;">
              <s:if
                ...
                <div data-options="iconCls:'icon-import'"
                  onClick="openwindow('/crm/upload.jsp?entityName=Role&namespace=system&title=' + '<s:text name="title.import.role" />')">
