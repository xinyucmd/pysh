...
<script type="text/javascript">
	 ...
	 function submit() {
		 ...
		 if($("#addObjectForm").form("validate")){
				 ...
				 $.messager.confirm("提交确认", "您确认生成回购申请吗？", function (saveAction) {
					if (saveAction) {
				 	var addObjectForm = document.getElementById('addObjectForm');
				 	addObjectForm.action='redeemGen.action';
...
<!-- 表单 -->			
	 <div id="feature-content">
	 		 <s:form id="addObjectForm" validate="true"  namespace="/jsp/redeem" method="post">
