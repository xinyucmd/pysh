          ...
          <tr>
            <td align="left" colspan="2"><label
              class="record-label"><s:text
                  name="convert.lead.message" />:</label></td>
          </tr>
          <tr>
            <td class="td-label"><label class="record-label"><s:text
                  name="convert.target.account" /></label></td>
            <td class="td-value"><s:checkbox id="accountCheck"
                name="accountCheck" /></td>
          </tr>
          <tr>
            <td class="td-label"><label class="record-label"><s:text
                  name="convert.target.contact" /></label></td>
            <td class="td-value"><s:checkbox id="contactCheck"
                name="contactCheck" /></td>
          </tr>
          <tr>
            <td class="td-label"><label class="record-label"><s:text
                  name="convert.target.opportunity" /></label></td>
            <td class="td-value"><s:checkbox id="opportunityCheck"
                name="opportunityCheck" /></td>
          </tr>
        </table>
      </s:form>
    </div>
