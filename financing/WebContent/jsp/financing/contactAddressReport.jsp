      ...
      <div id="shortcuts" class="headerList">
        <b style="white-space: nowrap; color: #444;"><s:text
          ...
          style="white-space: nowrap;"> <a
            href="contactAddressReportPDF.action"
            class="easyui-linkbutton" iconCls="icon-export" plain="true"
            target="_blank"><s:text name="action.export.pdf" /></a>
        </span> <span style="white-space: nowrap;"> <a
            href="contactAddressReportExcel.action"
            class="easyui-linkbutton" iconCls="icon-export" plain="true"><s:text
                name="action.export.excel" /></a>
        </span> <span style="white-space: nowrap;"> <a
            href="contactAddressReportCSV.action"
            class="easyui-linkbutton" iconCls="icon-export" plain="true"><s:text
