...
<script type="text/javascript">
	function send() {
		...
		addObjectForm.action = 'sendEmailCampaign.action';
	...
	function selectTemplate() {
		disableBtn();
		var addObjectForm = document.getElementById('addObjectForm');
		addObjectForm.action = 'selectCampaignTemplate.action';
		addObjectForm.submit();		
	}
	
	function cancel() {
		var addObjectForm = document.getElementById('addObjectForm');
		addObjectForm.action = 'editCampaign.action';
		addObjectForm.submit();	
	}
	
	function insertCampaign() {
		var value = $('#variableCampain').children('option:selected').val();
		if (value == '$campaign.start_date'){
			value = '<s:property value="startDate" />';
		} else if (value == '$campaign.end_date'){
          ...
          <table style="padding: 10px;" cellspacing="10" cellpadding="0"
            ...
            <tr>
              ...
              <td><span id="spanCampaign"> <select
                  ...
                  style="width: 150px;">
                    <option value="$campaign.start_date">
