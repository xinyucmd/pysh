    ...
    <div id="feature">
      ...
      <div id="feature-title">
        <s:if test="reportType!=null && reportType='pie'">
          <h2>
            <s:text name="report.leadBySourcePie.title" />
          </h2>
        </s:if>
        <s:else>
          <h2>
            <s:text name="report.leadBySourceBar.title" />
          </h2>
        </s:else>
      </div>
