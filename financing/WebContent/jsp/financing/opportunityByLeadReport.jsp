    ...
    <div id="feature">
      ...
      <div id="shortcuts" class="headerList">
        <b style="white-space: nowrap; color: #444;"><s:text
          ...
          style="white-space: nowrap;"> <a
            href="opportunityByLeadReportPage.action"
            class="easyui-linkbutton" iconCls="icon-pie" plain="true"><s:text
                name="action.report.pie" /></a>
        </span> <span style="white-space: nowrap;"> <a
            href="opportunityByLeadBar.action" class="easyui-linkbutton"
            iconCls="icon-bar" plain="true"><s:text
      ...
      <div id="feature-title">
        <s:if test="reportType!=null && reportType='pie'">
          <h2>
            <s:text name="report.opportunityByLeadPie.title" />
          </h2>
        </s:if>
        <s:else>
          <h2>
            <s:text name="report.opportunityByLeadBar.title" />
          </h2>
        </s:else>
      </div>
