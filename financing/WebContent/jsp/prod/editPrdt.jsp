...
<script type="text/javascript">
		...
		c = r.insertCell();
		c.innerHTML ="<select name='paymentType' class='record-value'  class='class java.util.HashMap'>    <option value='1'>利随本清</option>    <option value='2'>先息后本</option>  <option value='3'>等额本金</option> ></select>";
		...
		c = r.insertCell();
		c.innerHTML = "<td ><select name='ifRedeem' class='record-value'  class='class java.util.HashMap'>    <option value='0'>是</option>    <option value='1'>否</option></select>";
  ...
  <div id="page-wrap">
    ...
    <div id="feature">
      ...
      <div id="feature-title">
          ...
          <h2>
            <s:text name="menu.appProd.prodBase_information" />
          </h2>
					...
					<table style="padding: 10px;" cellspacing="10" cellpadding="0"
						...
						<tr>
							...
							<td class="td-value">
							      ...
							      <input name="prodBase.prdtNo" 
								  class="easyui-validatebox"  required="true" missingMessage="不能为空" class="record-value" />
							...
							<td class="td-value"><input name="prodBase.prdtName" class="easyui-validatebox"  required="true" missingMessage="不能为空"
						...
						<tr>
							...
							<td class="td-value"><input name="prodBase.standardAmt"  class="easyui-validatebox"  required="true" missingMessage="不能为空"
								class="record-value" /></td>
							<!--  advanceRedeem  -->
							...
							<td class="td-value"><s:select
									...
									listValue="opCnName" name="prodBase.advanceRedeem"></s:select></td>
          ...
          <div id="tt" class="easyui-tabs">
            <div title="<s:text name='menu.appProd.dingjia_information'/>"
              ...
              <div class="section-header">
                <span><s:text name="menu.appProd.proddingjia_information" /></span>
              </div>
              <table style="padding: 10px;" cellspacing="10" cellpadding="0"
						...
						<tr>
							...
							<td ><s:select
									...
									cssClass="record-value"></s:select></td>
						<td ><label class="record-label" style="float:right;"> <s:text
            ...
            <div title="<s:text name='menu.appProd.tiqianshuhui'/>"
              ...
              <table style="padding: 10px;" cellspacing="10" cellpadding="0"
						...
						<tr>
							...
							<td ><input name="stageMin"  
								cssClass="record-value" /> - <input name="stageMax"  
								cssClass="record-value" /><label class="record-label">
									期 </label></td>
							<td ><label class="record-label" style="float:right;"> <s:text
							...
							<td ><s:select
									class="record-value" 
									list="#select.queryWPD('YES_NO')" listKey="opCode"
									listValue="opCnName" name="ifRedeem"></s:select></td>
							...
							<td><input name="rate" 
								/> <label class="record-label">
									% </label></td>
							<td><a href="javascript:void(0)"   onclick="addFeeRate2()"
            plain="true">增加</a></td>
						</tr>
					</table>             
