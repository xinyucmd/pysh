...
import com.jiangchuanbanking.SMS.cn.b2m.eucp.sdkhttp.Mo;
import com.jiangchuanbanking.SMS.cn.b2m.eucp.sdkhttp.SDKServiceBindingStub;
import com.jiangchuanbanking.SMS.cn.b2m.eucp.sdkhttp.SDKServiceLocator;
import com.jiangchuanbanking.SMS.cn.b2m.eucp.sdkhttp.StatusReport;

public class Client {
	private String softwareSerialNo;
	private String key;
	static InputStream is = Client.class.getClassLoader().getResourceAsStream("config.properties");
	...
	public int sendSMS(String[] mobiles, String smsContent, String addSerial, int smsPriority) throws IOException {
		int value = -1;
		prop.load(is);
		String disjunctor = prop.getProperty("sms.disjunctor");
		if ("1".equals(disjunctor.trim())) {
