...
public class MoneyUtils {
	  ...
	  public static void main(String[] args) {
	    String number = "1.23";
	    System.out.println(number + " " + MoneyUtils.toChinese(number));
	...
	public static String getbxhj(PactInfo pactInfo,String amt){
	...
	public static String moneyFormat(Double amt){  
  
		       DecimalFormat df = new DecimalFormat("#,###.00");  
  
		       return df.format(amt);//123,456,789.123  
