...
<link href="<s:url value="/css/styles.css"/>" type="text/css" media="screen" rel="stylesheet" />
        ...
        <fieldset class="form">
          <p>
            <label class="loginlabel" for="j_username"><s:text
              ...
              onkeypress="keypressTab();" type="text" style='height:30px;'
          ...
          <p>
            <label class="loginlabel" for="j_password"> <s:text
              ...
              class="logininput ui-keyboard-input ui-widget-content ui-corner-all"
              name="j_password" id="j_password" type="password" style='height:30px;'
              onkeypress="keypress();" />
            </span>
          </p>
          <p>
