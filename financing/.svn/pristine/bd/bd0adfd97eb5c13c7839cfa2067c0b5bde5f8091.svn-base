  ...
  <div id="page-wrap">
    ...
    <div id="feature">
      ...
      <div id="shortcuts" class="headerList">
        <b style="white-space: nowrap; color: #444;"><s:text
            ...
            <span style="white-space: nowrap;"> <a
              href="editEmailTemplate.action" class="easyui-linkbutton"
              iconCls="icon-add" plain="true"><s:text
                  name="action.createEmailTemplate" /></a>
            </span>
            ...
            <span style="white-space: nowrap;"> <a id="delete"
              ...
              plain="true"><s:text name="action.deleteEmailTemplate" /></a>
            </span>
      ...
      <div id="feature-title">
        <h2>
          <s:text name="title.listEmailTemplate" />
        </h2>
      </div>
