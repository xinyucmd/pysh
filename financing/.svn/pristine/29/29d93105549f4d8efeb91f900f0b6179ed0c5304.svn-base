...
public class SystemParm {
	...
	**/
	 ...
	 * 2 单独做为一期无本金
	 */
	public static int  DEAL_ADVANCE_TYPE=1;
	/**
	...
	/** 等额本金 */
	public static final String RETURNMETHOD_PRINCIPAL = "3";

	/** 利随本清 */
	public static final String RETURNMETHOD_PROFITSCLEAR = "1";
	...
	/** 按计划 */
	public static final String RETURNMETHOD_PLAN = "6";
...
//		return systemDateServices.getSytstemDate().getNowDate();
//	}
//	
