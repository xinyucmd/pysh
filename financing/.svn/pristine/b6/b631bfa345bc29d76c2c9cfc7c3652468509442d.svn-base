    ...
    <div id="feature">
      ...
      <div id="shortcuts" class="headerList">
        <b style="white-space: nowrap; color: #444;"><s:text
            ...
            test="#session.loginUser.create_targetList == 1">
            ...
            <div id="mtm1" style="width: 150px;">
              <s:if
                test="#session.loginUser.create_targetList == 1 || #session.loginUser.update_targetList == 1">
                <div data-options="iconCls:'icon-import'"
                  onClick="openwindow('/crm/upload.jsp?entityName=TargetList&namespace=crm&title=' + '<s:text name="title.import.targetList" />')">
