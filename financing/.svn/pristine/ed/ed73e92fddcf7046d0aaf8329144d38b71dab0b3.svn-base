    ...
    <div id="feature">
      ...
      <div id="feature-title">
        <s:if test="reportType!=null && reportType='pie'">
          <h2>
            <s:text name="report.leadByStatusPie.title" />
          </h2>
        </s:if>
        <s:else>
          <h2>
            <s:text name="report.leadByStatusBar.title" />
          </h2>
        </s:else>
      </div>
