	  ...
	  var mygrid = jQuery("#grid").jqGrid({
			...
			height: "auto",
		   	...
		   	colModel:[
		   		...
		   		{name:'standardAmt',index:'standardAmt', width:100, resizable:true,sorttype:"int", formatter:urlFmatter},
		   		...
		   		{name:'sts',index:'sts', width:100, resizable:true, formatter:urlFmatter,stype:'select', 
				   		editoptions:{value:":全部;5:新建;20:审核不通过"}},
		...
		{  
		   ...
		   if (par == 1){
		     new_format_value = "<a href='editProd.action?prdtNo=" + rowObject[0] + "'>" + cellvalue + "</a>";
		   }else {
      ...
      <div id="shortcuts" class="headerList">
        <b style="white-space: nowrap; color: #444;"><s:text
            ...
            <span style="white-space: nowrap;"> <a
              href="addProd.action" class="easyui-linkbutton"
              iconCls="icon-add" plain="true"><s:text
                  name="action.createProd" /></a>
            </span>
