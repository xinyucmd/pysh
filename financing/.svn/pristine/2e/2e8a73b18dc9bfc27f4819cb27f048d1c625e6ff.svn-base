...
public class TestSDKClient {
	public static String softwareSerialNo = "6SDK-EMY-6688-KFSRM";// 软件序列号,请通过亿美销售人员获取
	public static String key = "JCJRBANKING";// 序列号首次激活时自己设定
	public static String password = "245800";// 密码,请通过亿美销售人员获取
	 ...
	 * @throws IOException 
	 */
	public static void testRegistEx() throws IOException {
		try {
	...
	public static void testSendSMS() {
		try {
			int i = SingletonClient.getClient().sendSMS(new String[] { "18610777154" }, "【微信贷】尊敬的微信贷用户XXX您好，请您前往邮箱完成激活验证。如有疑问请致电400-001-6007，祝您生活愉快！", "",5);// 带扩展码
