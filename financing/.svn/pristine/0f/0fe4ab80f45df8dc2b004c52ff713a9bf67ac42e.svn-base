			...
			onSelect:function(title){
		        if (title == "<s:text name='tab.relations'/>"){
					 var params = {
					  ...
					  $.ajax({
					    type: "POST",
					    url: "getTargetListRelationCounts.action",
					    data: params,
					    dataType:"text", 
					    success: function(json){  
					      ...
					      $("#targetNumber").html(obj.targetNumber); 
    ...
    <div id="feature">
      ...
      <div id="shortcuts" class="headerList">
        <b style="white-space: nowrap; color: #444;"><s:text
          ...
          </span> <s:if test="targetList!=null && targetList.id!=null">
              <span style="white-space: nowrap;"><a
                ...
                <div id="mtm1" style="width: 150px;">
                  <div data-options="iconCls:'icon-import'"
                    onClick="openwindow2('/crm/showChangeLogPage.action?entity=TargetList&recordID=' + '<s:property value="targetList.id" />',750,500)">
      ...
      <div id="feature-content">
        <s:form id="addObjectForm" validate="true" namespace="/jsp/crm"
          method="post">
          <s:hidden id="id" name="targetList.id"
            value="%{targetList.id}" />
                    ...
                    <div class="easyui-accordion" style="width: 200px;">
                      ...
                      <div title="<s:text name="menu.marketing.title"/>"
                        ...
                        <a
                          ...
                          target="contentFrame"><label
                          class="record-value menuLink"><s:text
                              name="menu.targets.title" />(<span
                            id="targetNumber"></span>)</label></a>
                      </div>
